...
%	
	\item The first line consists of \mintinline{igor}{#pragma rtGlobals=3} with optional comment
%	
...
%
	...
	\end{minted}
%
	\item Use brackets \mintinline{text}{()} sparingly\par
	Good:
	\begin{minted}{igor}
		variable a = b * (1 + 2)
...
%
\begin{itemize}
	\item Define them at the top of the file
%
	\item Make them \mintinline{igor}{static} if they are only required inside the same procedure file
%
	\item They are named with all caps and underlines if non-static
%
