...
Function EvaluateResult()
	...
	strswitch(includeFile)
		case "MIES_Include":
			...
			break
		case "UTF_Basic":
			CHECK_EQUAL_VAR(compilationState, 0x4) // "UTF_Basic"
			break
		case "UTF_PAPlot":
			CHECK_EQUAL_VAR(compilationState, 0x4) // "UTF_PAPlot"
			break
		case "UTF_HardwareAnalysisFunctions":
			CHECK_EQUAL_VAR(compilationState, 0x4) // "UTF_HardwareAnalysisFunctions"
			break
		case "UTF_HardwareBasic":
			CHECK_EQUAL_VAR(compilationState, 0x4) // "UTF_HardwareBasic"
			break
		default:
