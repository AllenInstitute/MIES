...
static Function/WAVE GetLBNEntries_IGNORE(string device, variable sweepNo, string name, [variable chunk])
	...
	strswitch(name)
		...
		case PSQ_FMT_LBN_RMS_LONG: // fallthrough
		case PSQ_FMT_LBN_RMS_SHORT_PASS: // fallthrough
		case PSQ_FMT_LBN_RMS_SHORT: // fallthrough
		...
		case PSQ_FMT_LBN_TARGETV_THRESHOLD:
			...
			return val
			break
		case LBN_DELTA_I: // fallthrough
		case LBN_DELTA_V: // fallthrough
		case LBN_RESISTANCE_FIT: // fallthrough
