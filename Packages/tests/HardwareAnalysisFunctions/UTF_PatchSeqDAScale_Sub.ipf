...
static Function/WAVE GetLBNEntries_IGNORE(string device, variable sweepNo, string name, [variable chunk])
	...
	strswitch(name)
		...
		case PSQ_FMT_LBN_RMS_LONG: // FIXME(CodeStyleFallthroughCaseRequireComment)
		case PSQ_FMT_LBN_RMS_SHORT_PASS: // FIXME(CodeStyleFallthroughCaseRequireComment)
		case PSQ_FMT_LBN_RMS_SHORT: // FIXME(CodeStyleFallthroughCaseRequireComment)
		...
		case PSQ_FMT_LBN_TARGETV_THRESHOLD:
			...
			return val
			break
		case LBN_DELTA_I: // FIXME(CodeStyleFallthroughCaseRequireComment)
		case LBN_DELTA_V: // FIXME(CodeStyleFallthroughCaseRequireComment)
		case LBN_RESISTANCE_FIT: // FIXME(CodeStyleFallthroughCaseRequireComment)
