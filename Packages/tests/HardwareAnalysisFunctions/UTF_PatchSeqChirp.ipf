...
static Function GlobalPreAcq(string device)
	...
	ret = AI_WriteToAmplifier(device, PSQ_TEST_HEADSTAGE, I_CLAMP_MODE, MCC_SETPRIMARYSIGNALLPF_FUNC, LPF_BYPASS)
	REQUIRE(!ret)
End
...
static Function CheckMCCLPF(string device, variable expectedValue)
	...
	val = AI_ReadFromAmplifier(device, PSQ_TEST_HEADSTAGE, I_CLAMP_MODE, MCC_GETPRIMARYSIGNALLPF_FUNC, NaN, selectAmp = 0)
