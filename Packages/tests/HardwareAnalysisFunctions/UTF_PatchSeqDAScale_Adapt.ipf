...
///  PS_DS_AD19   ✓                    ✓                            ✓                              ✓                         ✓                      ✓                            ✓                       ✓                                  ✓            ✓                    -                  ✓                      ✓                              ✓          ✓             -                      def               def                       def                            def                            25                          def                           def                       def
///============= ==================== ============================ ============================== ========================= ====================== ============================ ======================= ================================== ============ ==================== ================== ====================== ============================== ========== ============= ================= ========================= ============================== ============================== =========================== ============================= ========================= ===================
///
/// @endrst
...
static Function/WAVE GetLBNSingleEntry_IGNORE(string device, variable sweepNo, string name)
	...
	strswitch(name)
		...
		case PSQ_FMT_LBN_SWEEP_EXCEPT_BL_PASS:
...
static Function/WAVE GetEntries_IGNORE(string device, variable sweepNo)
	...
	wv[%sweepPassExceptBL] = GetLBNSingleEntry_IGNORE(device, sweepNo, PSQ_FMT_LBN_SWEEP_EXCEPT_BL_PASS)
...
static Function PS_DS_AD1a_REENTRY([string str])
	...
	CHECK_EQUAL_WAVES(entries[%fiNegSlopePass], {0, 1, 1}, mode = WAVE_DATA)
...
static Function PS_DS_AD12_REENTRY([string str])
	...
	CHECK_EQUAL_WAVES(entries[%sweepPassExceptBL], {1, 1, 1, 1}, mode = WAVE_DATA)
