...
static Function/WAVE GetLBNSingleEntry_IGNORE(string device, variable sweepNo, string name, [variable chunk])
	...
	strswitch(name)
		...
		case PSQ_FMT_LBN_SET_PASS:
			...
			Make/D/FREE wv = {val}
			return wv
		case PSQ_FMT_LBN_VM_FULL_AVG: // FIXME(CodeStyleFallthroughCaseRequireComment)
		case PSQ_FMT_LBN_VM_FULL_AVG_ADIFF: // FIXME(CodeStyleFallthroughCaseRequireComment)
		case PSQ_FMT_LBN_VM_FULL_AVG_ADIFF_PASS: // FIXME(CodeStyleFallthroughCaseRequireComment)
		case PSQ_FMT_LBN_VM_FULL_AVG_RDIFF: // FIXME(CodeStyleFallthroughCaseRequireComment)
		case PSQ_FMT_LBN_VM_FULL_AVG_RDIFF_PASS: // FIXME(CodeStyleFallthroughCaseRequireComment)
		...
		case "Inter-trial interval": // FIXME(CodeStyleFallthroughCaseRequireComment)
