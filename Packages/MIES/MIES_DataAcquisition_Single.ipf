...
Function DQS_StartDAQSingleDevice(panelTitle, [useBackground])
	...
	if(dataAcqRunMode == DAQ_NOT_RUNNING)
		...
		if(ParamIsDefault(useBackground))
			useBackground = DAP_GetValueFromNumStateWave(panelTitle, "Check_Settings_BackgrndDataAcq")
		else
...
static Function DQS_StopDataAcq()
	...
	if(RA_IsFirstSweep(panelTitleG))
		if(DAP_GetValueFromNumStateWave(panelTitleG, "Check_DataAcq1_RepeatAcq"))
