...
Window DA_Ephys() : Panel
	...
	NewPanel /K=1 /W=(979,53,1483,939)
	...
	ValDisplay valdisp_DataAcq_P_3,pos={224.00,351.00},size={35.00,21.00},bodyWidth=35,disable=1
	...
	CheckBox Check_Settings_TrigIn,pos={33.00,276.00},size={50.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="\\JCTrig In"
	...
	CheckBox Check_Settings_Append,pos={33.00,468.00},size={145.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Enable async acquisition"
	...
	PopupMenu popup_Settings_Amplifier,pos={15.00,357.00},size={235.00,19.00},bodyWidth=150,proc=DAP_PopMenuProc_CAA,title="Amplfier (700B)"
	...
	CheckBox check_Settings_ShowScopeWindow,pos={33.00,558.00},size={127.00,15.00},disable=1,proc=DAP_CheckProc_ShowScopeWin,title="Show Scope Window"
	...
	CheckBox check_Settings_Option_3,pos={246.00,378.00},size={133.00,30.00},disable=1,proc=DAP_CheckProc_LockedLogic,title="Repeat set B\runtil set A is complete"
	...
	CheckBox check_Settings_ScalingZero,pos={246.00,321.00},size={140.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Set channel scaling to 0"
	...
	CheckBox check_Settings_SetOption_04,pos={246.00,351.00},size={116.00,15.00},disable=3,proc=DAP_CheckProc_UpdateGuiState,title="Turn off headstage"
	...
	TitleBox title_Settings_SetCondition_00,pos={114.00,345.00},size={5.00,15.00},disable=1,title="\\f01/"
	...
	TitleBox title_Settings_SetCondition_01,pos={114.00,381.00},size={5.00,15.00},disable=1,title="\\f01\\"
	...
	TitleBox title_Settings_SetCondition_04,pos={237.00,345.00},size={5.00,15.00},disable=1,title="\\f01\\"
	...
	TitleBox title_Settings_SetCondition_02,pos={237.00,324.00},size={5.00,15.00},disable=1,title="\\f01/"
	...
	TitleBox title_Settings_SetCondition_03,pos={204.00,333.00},size={35.00,15.00},disable=1,title="\\f01-------"
	...
	SetVariable setvar_DataAcq_TerminationDelay,pos={286.00,675.00},size={177.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="Termination delay (ms)"
	...
	TitleBox title_Settings_SetCondition_1,pos={207.00,396.00},size={35.00,15.00},disable=1,title="\\f01-------"
	...
	TitleBox title_Settings_SetCondition_2,pos={237.00,408.00},size={5.00,15.00},disable=1,title="\\f01\\"
	...
	TitleBox title_Settings_SetCondition_3,pos={237.00,387.00},size={5.00,15.00},disable=1,title="\\f01/"
	...
	CheckBox check_Settings_SetOption_5,pos={246.00,408.00},size={103.00,30.00},disable=1,proc=DAP_CheckProc_LockedLogic,title="Index to next set\ron DA with set B"
	...
	TitleBox title_Settings_SetCondition2,pos={126.00,324.00},size={86.00,24.00},disable=1,title="\\Z10Stop Acquisition on\rDA with Set B"
	...
	SetVariable setvar_DataAcq_Hold_VC,pos={31.00,171.00},size={93.00,18.00},bodyWidth=46,disable=1,proc=DAP_SetVarProc_AmpCntrls,title="Holding"
	...
	SetVariable setvar_DataAcq_WCR,pos={98.00,219.00},size={74.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_AmpCntrls,title="MΩ"
	...
	SetVariable setvar_DataAcq_WCC,pos={24.00,219.00},size={67.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_AmpCntrls,title="pF"
	...
	SetVariable setvar_DataAcq_RsPred,pos={191.00,237.00},size={119.00,18.00},bodyWidth=40,disable=1,proc=DAP_SetVarProc_AmpCntrls,title="Prediction (%)"
	...
	CheckBox Check_Settings_AlarmPauseAcq,pos={33.00,492.00},size={182.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="\\JCPause acquisition in alarm state"
	...
	CheckBox Check_Settings_AlarmAutoRepeat,pos={33.00,513.00},size={275.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Auto repeat last sweep until alarm state is cleared"
	...
	SetVariable setvar_Settings_TPBuffer,pos={331.00,108.00},size={125.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="TP Buffer size"
	...
	SetVariable setvar_Settings_TP_RTolerance,pos={314.00,84.00},size={145.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="Min delta R (MΩ)"
	...
	SetVariable setvar_Settings_InAirP,pos={43.00,741.00},size={116.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="In air P (psi)"
	...
	SetVariable setvar_Settings_InBathP,pos={179.00,741.00},size={127.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="In bath P (psi)"
	...
	SetVariable setvar_Settings_NearCellP,pos={23.00,768.00},size={136.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="Near cell P (psi)"
	...
	SetVariable setvar_Settings_SealStartP,pos={172.00,768.00},size={131.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="Seal Init P (psi)"
	...
	SetVariable setvar_Settings_SealMaxP,pos={314.00,768.00},size={136.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="Seal max P (psi)"
	...
	SetVariable setvar_Settings_SurfaceHeight,pos={23.00,795.00},size={136.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="Sol surface\\Z11 (µm)"
	...
	ValDisplay valdisp_DataAcq_P_0,pos={37.00,351.00},size={99.00,21.00},bodyWidth=35,disable=1,title="\\Z10Pressure (psi) "
	...
	ValDisplay valdisp_DataAcq_P_1,pos={137.00,351.00},size={35.00,21.00},bodyWidth=35,disable=1
	...
	ValDisplay valdisp_DataAcq_P_2,pos={179.00,351.00},size={35.00,21.00},bodyWidth=35,disable=1
	...
	ValDisplay valdisp_DataAcq_P_4,pos={266.00,351.00},size={35.00,21.00},bodyWidth=35,disable=1
	...
	ValDisplay valdisp_DataAcq_P_5,pos={308.00,351.00},size={35.00,21.00},bodyWidth=35,disable=1
	...
	ValDisplay valdisp_DataAcq_P_6,pos={353.00,351.00},size={35.00,21.00},bodyWidth=35,disable=1
	...
	ValDisplay valdisp_DataAcq_P_7,pos={395.00,351.00},size={35.00,21.00},bodyWidth=35,disable=1
	...
	CheckBox check_settings_show_power,pos={27.00,159.00},size={134.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Show power spectrum"
	...
	PopupMenu Popup_Settings_OsciUpdMode,pos={33.00,579.00},size={177.00,19.00},bodyWidth=80,disable=1,proc=DAP_PopMenuProc_OsciUpdMode,title="TP Update Y scale"
	...
	SetVariable setvar_Settings_OsciUpdInt,pos={218.00,579.00},size={178.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="TP Update interval [ms]"
