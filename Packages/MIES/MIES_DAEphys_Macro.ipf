...
Window DA_Ephys() : Panel
	...
	ValDisplay valdisp_DataAcq_P_LED_BreakIn,pos={255.60,297.60},size={85.80,28.80},disable=1
	...
	ValDisplay valdisp_DataAcq_P_LED_Seal,pos={145.80,297.60},size={85.80,28.80},disable=1
	...
	ValDisplay valdisp_DataAcq_P_LED_Approach,pos={36.00,297.60},size={85.80,28.80},disable=1
	...
	ValDisplay valdisp_DataAcq_P_LED_7,pos={406.80,346.80},size={42.60,28.80},disable=1
	...
	ValDisplay valdisp_DataAcq_P_LED_6,pos={363.60,346.80},size={42.60,28.80},disable=1
	...
	ValDisplay valdisp_DataAcq_P_LED_5,pos={321.00,346.80},size={42.60,28.80},disable=1
	...
	ValDisplay valdisp_DataAcq_P_LED_4,pos={277.80,346.80},size={42.60,28.80},disable=1
	...
	ValDisplay valdisp_DataAcq_P_LED_3,pos={234.60,346.80},size={42.60,28.80},disable=1
	...
	ValDisplay valdisp_DataAcq_P_LED_2,pos={192.00,346.80},size={42.60,28.80},disable=1
	...
	ValDisplay valdisp_DataAcq_P_LED_0,pos={105.60,346.80},size={42.60,28.80},disable=1
	...
	ValDisplay valdisp_DataAcq_P_LED_1,pos={148.80,346.80},size={42.60,28.80},disable=1
	...
	ValDisplay valdisp_DataAcq_P_3,pos={238.80,351.00},size={34.80,21.00},bodyWidth=35,disable=1
	...
	GroupBox group_DataAcq_WholeCell,pos={40.80,199.80},size={150.00,61.80},disable=1,title="       Whole Cell"
	...
	TitleBox Title_settings_SetManagement,pos={948.00,-99.60},size={391.80,213.00},disable=1,title="Set Management Decision Tree"
	...
	TabControl ADC,pos={3.00,0.60},size={478.80,18.60},proc=ACL_DisplayTab
	...
	CheckBox Check_AD_00,pos={19.80,75.00},size={21.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="0"
	...
	CheckBox Check_AD_01,pos={19.80,120.60},size={21.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="1"
	...
	CheckBox Check_AD_02,pos={19.80,166.80},size={21.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="2"
	...
	CheckBox Check_AD_03,pos={19.80,213.60},size={21.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="3"
	...
	CheckBox Check_AD_04,pos={19.80,259.80},size={21.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="4"
	...
	CheckBox Check_AD_05,pos={19.80,306.60},size={21.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="5"
	...
	CheckBox Check_AD_06,pos={19.80,352.80},size={21.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="6"
	...
	CheckBox Check_AD_07,pos={19.80,399.60},size={21.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="7"
	...
	CheckBox Check_AD_08,pos={199.80,75.00},size={21.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="8"
	...
	CheckBox Check_AD_09,pos={199.80,120.60},size={21.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="9"
	...
	CheckBox Check_AD_10,pos={193.80,166.80},size={27.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="10"
	...
	CheckBox Check_AD_12,pos={193.80,259.80},size={27.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="12"
	...
	CheckBox Check_AD_11,pos={193.80,213.60},size={27.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="11"
	...
	SetVariable Gain_AD_00,pos={49.80,75.00},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_01,pos={49.80,120.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_02,pos={49.80,166.80},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_03,pos={49.80,213.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_04,pos={49.80,259.80},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_05,pos={49.80,306.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_06,pos={49.80,352.80},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_07,pos={49.80,399.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_08,pos={228.60,75.00},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_09,pos={228.60,120.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_10,pos={228.60,166.80},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_11,pos={228.60,213.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_12,pos={228.60,259.80},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	CheckBox Check_AD_13,pos={193.80,306.60},size={27.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="13"
	...
	CheckBox Check_AD_14,pos={193.80,352.80},size={27.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="14"
	...
	CheckBox Check_AD_15,pos={193.80,399.60},size={27.00,15.00},disable=1,proc=DAP_CheckProc_AD,title="15"
	...
	SetVariable Gain_AD_13,pos={228.60,306.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_14,pos={228.60,352.80},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_AD_15,pos={228.60,399.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	CheckBox Check_DA_00,pos={19.80,75.00},size={21.60,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="0"
	...
	CheckBox Check_DA_01,pos={19.80,120.60},size={21.60,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="1"
	...
	CheckBox Check_DA_02,pos={19.80,166.80},size={21.60,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="2"
	...
	CheckBox Check_DA_03,pos={19.80,213.60},size={21.60,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="3"
	...
	CheckBox Check_DA_04,pos={19.80,259.80},size={21.60,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="4"
	...
	CheckBox Check_DA_05,pos={19.80,306.60},size={21.60,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="5"
	...
	CheckBox Check_DA_06,pos={19.80,352.80},size={21.60,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="6"
	...
	CheckBox Check_DA_07,pos={19.80,399.60},size={21.60,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="7"
	...
	SetVariable Gain_DA_00,pos={49.80,75.00},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_DA_01,pos={49.80,120.60},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_DA_02,pos={49.80,166.80},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_DA_03,pos={49.80,213.60},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_DA_04,pos={49.80,259.80},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_DA_05,pos={49.80,306.60},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_DA_06,pos={49.80,352.80},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Gain_DA_07,pos={49.80,399.60},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	PopupMenu Wave_DA_00,pos={139.80,75.00},size={138.00,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList,title="/V"
	...
	PopupMenu Wave_DA_01,pos={139.80,120.60},size={138.00,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList,title="/V"
	...
	PopupMenu Wave_DA_02,pos={139.80,166.80},size={138.00,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList,title="/V"
	...
	PopupMenu Wave_DA_03,pos={139.80,213.60},size={138.00,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList,title="/V"
	...
	PopupMenu Wave_DA_04,pos={139.80,259.80},size={138.00,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList,title="/V"
	...
	PopupMenu Wave_DA_05,pos={139.80,306.60},size={138.00,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList,title="/V"
	...
	PopupMenu Wave_DA_06,pos={139.80,352.80},size={138.00,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList,title="/V"
	...
	PopupMenu Wave_DA_07,pos={139.80,399.60},size={138.00,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList,title="/V"
	...
	SetVariable Scale_DA_00,pos={289.80,75.00},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Scale_DA_01,pos={289.80,120.60},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Scale_DA_02,pos={289.80,166.80},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Scale_DA_03,pos={289.80,213.60},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Scale_DA_04,pos={289.80,259.80},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Scale_DA_05,pos={289.80,306.60},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Scale_DA_06,pos={289.80,352.80},size={49.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Scale_DA_07,pos={289.80,399.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable SetVar_DataAcq_Comment,pos={48.00,780.60},size={361.80,13.80},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Comment"
	...
	Button DataAcquireButton,pos={43.80,798.60},size={405.00,42.00},disable=1,proc=DAP_ButtonProc_AcquireData,title="\\Z14\\f01Acquire\rData"
	...
	CheckBox Check_DataAcq1_RepeatAcq,pos={31.80,643.80},size={88.80,15.00},disable=1,proc=DAP_CheckProc_RepeatedAcq,title="Repeated Acq"
	...
	SetVariable SetVar_DataAcq_ITI,pos={60.00,699.60},size={79.80,18.00},bodyWidth=35,disable=1,proc=DAP_SetVarProc_SyncCtrl,title="\\JCITl (sec)"
	...
	Button StartTestPulseButton,pos={42.60,444.00},size={405.00,39.60},disable=1,proc=DAP_ButtonProc_TestPulse,title="\\Z14\\f01Start Test \rPulse"
	...
	CheckBox Check_DataAcqHS_00,pos={129.00,85.80},size={21.60,15.00},disable=1,proc=DAP_CheckProc_HedstgeChck,title="0"
	...
	SetVariable SetVar_DataAcq_TPDuration,pos={45.60,417.00},size={126.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_TestPulseSett,title="Duration (ms)"
	...
	SetVariable SetVar_DataAcq_TPBaselinePerc,pos={178.80,417.00},size={117.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_TestPulseSett,title="Baseline (%)"
	...
	SetVariable SetVar_DataAcq_TPAmplitude,pos={307.80,417.00},size={69.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_TPAmp,title="VC"
	...
	CheckBox Check_TTL_00,pos={19.80,75.00},size={21.00,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="0"
	...
	CheckBox Check_TTL_01,pos={19.80,120.60},size={21.00,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="1"
	...
	CheckBox Check_TTL_02,pos={19.80,166.80},size={21.00,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="2"
	...
	CheckBox Check_TTL_03,pos={19.80,213.60},size={21.00,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="3"
	...
	CheckBox Check_TTL_04,pos={19.80,259.80},size={21.00,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="4"
	...
	CheckBox Check_TTL_05,pos={19.80,306.60},size={21.00,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="5"
	...
	CheckBox Check_TTL_06,pos={19.80,352.80},size={21.00,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="6"
	...
	CheckBox Check_TTL_07,pos={19.80,399.60},size={21.00,15.00},disable=1,proc=DAP_DAorTTLCheckProc,title="7"
	...
	PopupMenu Wave_TTL_00,pos={102.60,75.00},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu Wave_TTL_01,pos={102.60,120.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu Wave_TTL_02,pos={102.60,166.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu Wave_TTL_03,pos={102.60,213.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu Wave_TTL_04,pos={102.60,259.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu Wave_TTL_05,pos={102.60,306.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu Wave_TTL_06,pos={102.60,352.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu Wave_TTL_07,pos={102.60,399.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	SetVariable SetVar_DataAcq_SetRepeats,pos={33.00,679.80},size={106.80,18.00},bodyWidth=35,disable=1,proc=DAP_SetVarProc_TotSweepCount,title="Repeat Set(s)"
	...
	ValDisplay ValDisp_DataAcq_SamplingInt,pos={228.60,573.60},size={30.00,21.00},bodyWidth=30,disable=1
	...
	SetVariable SetVar_Sweep,pos={210.60,531.60},size={75.00,34.80},bodyWidth=75,disable=1,proc=DAP_SetVarProc_NextSweepLimit
	...
	CheckBox Check_Settings_UseDoublePrec,pos={243.00,217.80},size={160.80,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Use Double Precision Floats"
	...
	CheckBox Check_Settings_SkipAnalysFuncs,pos={243.00,267.60},size={156.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Skip analysis function calls"
	...
	SetVariable Gain_AsyncAD_00,pos={223.80,43.80},size={76.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="gain"
	...
	SetVariable Gain_AsyncAD_01,pos={223.80,94.80},size={76.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="gain"
	...
	SetVariable Gain_AsyncAD_02,pos={223.80,145.80},size={76.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="gain"
	...
	SetVariable Gain_AsyncAD_03,pos={223.80,196.80},size={76.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="gain"
	...
	SetVariable Gain_AsyncAD_04,pos={223.80,247.80},size={76.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="gain"
	...
	SetVariable Gain_AsyncAD_05,pos={223.80,298.80},size={76.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="gain"
	...
	SetVariable Gain_AsyncAD_06,pos={223.80,349.80},size={76.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="gain"
	...
	SetVariable Gain_AsyncAD_07,pos={223.80,402.00},size={76.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="gain"
	...
	SetVariable Title_AsyncAD_00,pos={13.80,43.80},size={150.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Title"
	...
	SetVariable Title_AsyncAD_01,pos={13.80,94.80},size={150.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Title"
	...
	SetVariable Title_AsyncAD_02,pos={13.80,145.80},size={150.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Title"
	...
	SetVariable Title_AsyncAD_03,pos={13.80,196.80},size={150.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Title"
	...
	SetVariable Title_AsyncAD_04,pos={10.80,247.80},size={150.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Title"
	...
	SetVariable Title_AsyncAD_05,pos={13.80,298.80},size={150.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Title"
	...
	SetVariable Title_AsyncAD_06,pos={13.80,349.80},size={150.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Title"
	...
	SetVariable Title_AsyncAD_07,pos={13.80,402.00},size={150.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Title"
	...
	SetVariable Unit_AsyncAD_00,pos={315.00,43.80},size={75.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Unit"
	...
	SetVariable Unit_AsyncAD_01,pos={315.00,94.80},size={75.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Unit"
	...
	SetVariable Unit_AsyncAD_02,pos={315.00,145.80},size={75.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Unit"
	...
	SetVariable Unit_AsyncAD_03,pos={315.00,196.80},size={75.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Unit"
	...
	SetVariable Unit_AsyncAD_04,pos={315.00,247.80},size={75.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Unit"
	...
	SetVariable Unit_AsyncAD_05,pos={315.00,297.60},size={75.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Unit"
	...
	SetVariable Unit_AsyncAD_06,pos={315.00,349.80},size={75.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Unit"
	...
	CheckBox Check_Settings_Append,pos={33.60,451.80},size={144.60,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Enable async acquisition"
	...
	CheckBox Radio_ClampMode_0,pos={129.00,61.80},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	TitleBox Title_DataAcq_VC,pos={42.60,60.00},size={78.00,15.00},disable=1,title="Voltage Clamp"
	...
	TitleBox Title_DataAcq_IC,pos={42.60,108.60},size={78.00,15.00},disable=1,title="Current Clamp"
	...
	TitleBox Title_DataAcq_CellSelection,pos={57.60,84.60},size={55.80,15.00},disable=1,title="Headstage"
	...
	CheckBox Check_DataAcqHS_01,pos={162.00,85.80},size={21.60,15.00},disable=1,proc=DAP_CheckProc_HedstgeChck,title="1"
	...
	CheckBox Check_DataAcqHS_02,pos={195.60,85.80},size={21.60,15.00},disable=1,proc=DAP_CheckProc_HedstgeChck,title="2"
	...
	CheckBox Check_DataAcqHS_03,pos={229.80,85.80},size={21.60,15.00},disable=1,proc=DAP_CheckProc_HedstgeChck,title="3"
	...
	CheckBox Check_DataAcqHS_04,pos={264.00,85.80},size={21.60,15.00},disable=1,proc=DAP_CheckProc_HedstgeChck,title="4"
	...
	CheckBox Check_DataAcqHS_05,pos={297.60,85.80},size={21.60,15.00},disable=1,proc=DAP_CheckProc_HedstgeChck,title="5"
	...
	CheckBox Check_DataAcqHS_06,pos={331.80,85.80},size={21.60,15.00},disable=1,proc=DAP_CheckProc_HedstgeChck,title="6"
	...
	CheckBox Check_DataAcqHS_07,pos={366.00,84.60},size={21.60,15.00},disable=1,proc=DAP_CheckProc_HedstgeChck,title="7"
	...
	CheckBox Radio_ClampMode_1,pos={129.00,111.00},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_2,pos={162.00,61.80},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_3,pos={162.00,111.00},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_4,pos={195.60,61.80},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_5,pos={195.60,111.00},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_6,pos={229.80,61.80},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_7,pos={229.80,111.00},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_8,pos={264.00,61.80},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_9,pos={264.00,111.00},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_10,pos={297.60,61.80},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_11,pos={297.60,111.00},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_12,pos={331.80,61.80},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_13,pos={331.80,111.00},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_14,pos={366.00,61.80},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_15,pos={366.00,111.00},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_1IZ,pos={129.60,180.60},size={12.60,12.60},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_3IZ,pos={162.60,180.60},size={12.60,12.60},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_5IZ,pos={196.80,180.60},size={12.60,12.60},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_7IZ,pos={231.00,180.60},size={12.60,12.60},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_9IZ,pos={264.60,180.60},size={12.60,12.60},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_11IZ,pos={298.80,180.60},size={12.60,12.60},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_13IZ,pos={333.00,180.60},size={12.60,12.60},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_15IZ,pos={366.60,180.60},size={12.60,12.60},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	TitleBox Title_DataAcq_IE0,pos={66.60,178.80},size={54.60,15.00},disable=1,title="I=0 Clamp"
	...
	PopupMenu Popup_Settings_VC_DA,pos={45.60,411.00},size={32.40,14.40},proc=DAP_PopMenuProc_CAA,title="DA"
	...
	PopupMenu Popup_Settings_VC_AD,pos={45.60,435.60},size={32.40,14.40},proc=DAP_PopMenuProc_CAA,title="AD"
	...
	PopupMenu Popup_Settings_IC_AD,pos={225.60,435.60},size={32.40,14.40},proc=DAP_PopMenuProc_CAA,title="AD"
	...
	SetVariable setvar_Settings_VC_DAgain,pos={106.80,412.80},size={49.80,13.80},proc=DAP_SetVarProc_CAA
	...
	SetVariable setvar_Settings_VC_ADgain,pos={106.80,438.00},size={49.80,13.80},proc=DAP_SetVarProc_CAA
	...
	SetVariable setvar_Settings_IC_ADgain,pos={286.80,438.00},size={49.80,13.80},proc=DAP_SetVarProc_CAA
	...
	PopupMenu Popup_Settings_HeadStage,pos={45.60,328.80},size={66.60,14.40},proc=DAP_PopMenuProc_Headstage,title="Head Stage"
	...
	PopupMenu popup_Settings_Amplifier,pos={54.60,357.60},size={214.80,14.40},bodyWidth=150,proc=DAP_PopMenuProc_CAA,title="Amplfier (700B)"
	...
	PopupMenu Popup_Settings_IC_DA,pos={225.60,411.00},size={32.40,14.40},proc=DAP_PopMenuProc_CAA,title="DA"
	...
	SetVariable setvar_Settings_IC_DAgain,pos={288.00,412.80},size={49.80,13.80},proc=DAP_SetVarProc_CAA
	...
	TitleBox Title_settings_Hardware_VC,pos={57.00,394.80},size={34.80,12.00},title="V-Clamp"
	...
	TitleBox Title_settings_ChanlAssign_IC,pos={238.80,394.80},size={31.80,12.00},title="I-Clamp"
	...
	Button button_Settings_UpdateAmpStatus,pos={276.00,357.60},size={150.00,19.80},proc=DAP_ButtonCtrlFindConnectedAmps,title="Query connected Amp(s)"
	...
	SetVariable Search_DA_00,pos={153.00,96.60},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_DA_01,pos={153.00,142.80},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_DA_02,pos={153.00,189.00},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_DA_03,pos={153.00,235.80},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_DA_04,pos={153.00,282.00},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_DA_05,pos={153.00,328.80},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_DA_06,pos={153.00,375.00},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_DA_07,pos={153.00,421.80},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_TTL_00,pos={102.00,96.60},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_TTL_01,pos={102.00,142.80},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_TTL_02,pos={102.00,189.60},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_TTL_03,pos={102.00,237.00},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_TTL_04,pos={102.00,283.80},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_TTL_05,pos={102.00,330.60},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_TTL_06,pos={102.00,378.00},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Search_TTL_07,pos={102.00,424.80},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	CheckBox Check_DataAcq_Indexing,pos={204.00,679.80},size={60.60,15.00},disable=1,proc=DAP_CheckProc_IndexingState,title="Indexing"
	...
	TitleBox Title_DA_IndexStartEnd,pos={348.60,49.80},size={93.60,15.00},disable=1,title="\\JCIndexing End Set"
	...
	TitleBox Title_DA_Gain,pos={54.60,49.80},size={24.60,15.00},disable=1,title="Gain"
	...
	TitleBox Title_DA_DAWaveSelect,pos={153.60,49.80},size={111.00,15.00},disable=1,title="(first) DA Set Select"
	...
	TitleBox Title_DA_Scale,pos={292.80,49.80},size={28.80,15.00},disable=1,title="Scale"
	...
	TitleBox Title_DA_Channel,pos={24.60,49.80},size={16.80,15.00},disable=1,title="DA"
	...
	PopupMenu IndexEnd_DA_00,pos={352.80,75.00},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_DA_01,pos={352.80,120.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_DA_02,pos={352.80,166.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_DA_03,pos={352.80,213.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_DA_04,pos={352.80,259.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_DA_05,pos={352.80,306.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_DA_06,pos={352.80,352.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_DA_07,pos={352.80,399.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_TTL_00,pos={243.00,75.00},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_TTL_01,pos={241.80,120.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_TTL_02,pos={241.80,166.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_TTL_03,pos={241.80,213.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_TTL_04,pos={241.80,259.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_TTL_05,pos={241.80,306.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_TTL_06,pos={241.80,352.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	PopupMenu IndexEnd_TTL_07,pos={243.00,399.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	CheckBox check_Settings_ShowScopeWindow,pos={33.60,546.00},size={126.60,15.00},disable=1,proc=DAP_CheckProc_ShowScopeWin,title="Show Scope Window"
	...
	Button button_DataAcq_TurnOffAllChan,pos={435.00,72.60},size={30.00,39.60},disable=1,proc=DAP_ButtonProc_AllChanOff,title="OFF"
	...
	CheckBox check_Settings_ITITP,pos={33.60,108.60},size={129.60,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Activate TP during ITI"
	...
	ValDisplay valdisp_DataAcq_ITICountdown,pos={67.80,565.80},size={132.00,21.00},bodyWidth=30,disable=1,title="ITI remaining (s)"
	...
	ValDisplay valdisp_DataAcq_TrialsCountdown,pos={57.00,538.80},size={144.00,21.00},bodyWidth=30,disable=1,title="Sweeps remaining"
	...
	SetVariable min_AsyncAD_00,pos={108.60,66.00},size={75.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="min"
	...
	SetVariable max_AsyncAD_00,pos={196.80,66.00},size={75.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="max"
	...
	SetVariable min_AsyncAD_01,pos={108.60,117.00},size={75.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="min"
	...
	SetVariable max_AsyncAD_01,pos={196.80,117.00},size={75.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="max"
	...
	SetVariable min_AsyncAD_02,pos={108.60,168.60},size={75.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="min"
	...
	SetVariable max_AsyncAD_02,pos={196.80,168.60},size={75.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="max"
	...
	SetVariable min_AsyncAD_03,pos={108.60,219.60},size={75.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="min"
	...
	SetVariable max_AsyncAD_03,pos={196.80,219.60},size={75.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="max"
	...
	SetVariable min_AsyncAD_04,pos={108.60,271.80},size={75.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="min"
	...
	SetVariable max_AsyncAD_04,pos={196.80,271.80},size={75.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="max"
	...
	SetVariable min_AsyncAD_05,pos={108.60,322.80},size={75.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="min"
	...
	SetVariable max_AsyncAD_05,pos={196.80,322.80},size={75.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="max"
	...
	SetVariable min_AsyncAD_06,pos={108.60,375.00},size={75.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="min"
	...
	SetVariable max_AsyncAD_06,pos={196.80,375.00},size={75.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="max"
	...
	SetVariable min_AsyncAD_07,pos={108.60,426.60},size={75.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="min"
	...
	SetVariable max_AsyncAD_07,pos={196.80,426.60},size={75.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="max"
	...
	TitleBox Title_TTL_IndexStartEnd,pos={255.00,49.80},size={93.60,15.00},disable=1,title="\\JCIndexing End Set"
	...
	TitleBox Title_TTL_TTLWaveSelect,pos={99.60,49.80},size={114.00,15.00},disable=1,title="(first) TTL Set Select"
	...
	TitleBox Title_TTL_Channel,pos={24.60,49.80},size={46.80,15.00},disable=1,title="TTL(out)"
	...
	CheckBox check_DataAcq_RepAcqRandom,pos={66.00,660.00},size={60.60,15.00},disable=1,proc=DAP_CheckProc_RandomRA,title="Random"
	...
	TitleBox title_Settings_SetCondition,pos={60.00,345.60},size={57.00,12.00},disable=1,title="\\Z10Set A > Set B"
	...
	CheckBox check_Settings_Option_3,pos={246.00,360.00},size={132.60,30.00},disable=1,proc=DAP_CheckProc_LockedLogic,title="Repeat set B\runtil set A is complete"
	...
	CheckBox check_Settings_ScalingZero,pos={246.00,303.00},size={139.80,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Set channel scaling to 0"
	...
	CheckBox check_Settings_SetOption_04,pos={246.00,333.00},size={115.80,15.00},disable=3,proc=DAP_CheckProc_UpdateGuiState,title="Turn off headstage"
	...
	TitleBox title_Settings_SetCondition_00,pos={114.00,327.60},size={4.80,15.00},disable=1,title="\\f01/"
	...
	TitleBox title_Settings_SetCondition_01,pos={114.00,364.80},size={4.80,15.00},disable=1,title="\\f01\\"
	...
	TitleBox title_Settings_SetCondition_04,pos={238.80,327.60},size={4.80,15.00},disable=1,title="\\f01\\"
	...
	TitleBox title_Settings_SetCondition_02,pos={237.60,306.60},size={4.80,15.00},disable=1,title="\\f01/"
	...
	TitleBox title_Settings_SetCondition_03,pos={205.80,316.80},size={34.80,15.00},disable=1,title="\\f01-------"
	...
	PopupMenu popup_MoreSettings_DeviceType,pos={44.40,72.60},size={148.20,14.40},bodyWidth=100,proc=DAP_PopMenuProc_DevTypeChk,title="Device type"
	...
	PopupMenu popup_moreSettings_DeviceNo,pos={73.20,99.60},size={119.40,14.40},bodyWidth=58,title="Device number"
	...
	SetVariable setvar_DataAcq_TerminationDelay,pos={286.80,657.00},size={177.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="Termination delay (ms)"
	...
	GroupBox group_Hardware_FolderPath,pos={22.80,48.60},size={444.60,105.00},title="Lock a device to generate device folder structure"
	...
	Button button_SettingsPlus_PingDevice,pos={42.60,126.00},size={150.00,19.80},proc=DAP_ButtonProc_Settings_OpenDev,title="Open device"
	...
	Button button_SettingsPlus_LockDevice,pos={202.80,72.60},size={84.60,45.60},proc=DAP_ButtonProc_LockDev,title="Lock device\r selection"
	...
	Button button_SettingsPlus_unLockDevic,pos={294.60,72.60},size={84.60,45.60},disable=2,proc=DAP_ButProc_Hrdwr_UnlckDev,title="Unlock device\r selection"
	...
	TitleBox title_Settings_SetCondition_1,pos={207.00,379.80},size={34.80,15.00},disable=1,title="\\f01-------"
	...
	TitleBox title_Settings_SetCondition_2,pos={238.80,390.60},size={4.80,15.00},disable=1,title="\\f01\\"
	...
	TitleBox title_Settings_SetCondition_3,pos={238.80,369.60},size={4.80,15.00},disable=1,title="\\f01/"
	...
	CheckBox check_Settings_SetOption_5,pos={246.00,390.00},size={102.60,30.00},disable=1,proc=DAP_CheckProc_LockedLogic,title="Index to next set\ron DA with set B"
	...
	TitleBox title_Settings_SetCondition1,pos={123.60,367.80},size={90.00,24.00},disable=1,title="\\Z10Continue acquisition\ron DA with set B"
	...
	TitleBox title_Settings_SetCondition2,pos={126.00,307.80},size={85.80,24.00},disable=1,title="\\Z10Stop Acquisition on\rDA with Set B"
	...
	ValDisplay valdisp_DataAcq_SweepsInSet,pos={297.60,538.80},size={30.00,21.00},bodyWidth=30,disable=1
	...
	CheckBox Check_DataAcq1_IndexingLocked,pos={219.60,714.00},size={54.00,15.00},disable=1,proc=DAP_CheckProc_IndexingState,title="Locked"
	...
	SetVariable SetVar_DataAcq_ListRepeats,pos={144.00,733.80},size={108.60,18.00},bodyWidth=35,disable=1,proc=DAP_SetVarProc_TotSweepCount,title="Repeat List(s)"
	...
	CheckBox check_DataAcq_IndexRandom,pos={219.60,696.60},size={60.60,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Random"
	...
	ValDisplay valdisp_DataAcq_SweepsActiveSet,pos={297.60,565.80},size={30.00,21.00},bodyWidth=30,disable=1
	...
	SetVariable SetVar_DataAcq_TPAmplitudeIC,pos={381.00,417.00},size={64.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_TPAmp,title="IC"
	...
	SetVariable SetVar_Hardware_VC_DA_Unit,pos={165.00,412.80},size={30.00,13.80},proc=DAP_SetVarProc_CAA
	...
	SetVariable SetVar_Hardware_IC_DA_Unit,pos={343.80,414.00},size={30.00,13.80},proc=DAP_SetVarProc_CAA
	...
	SetVariable SetVar_Hardware_VC_AD_Unit,pos={186.00,438.00},size={30.00,13.80},proc=DAP_SetVarProc_CAA
	...
	SetVariable SetVar_Hardware_IC_AD_Unit,pos={366.60,438.00},size={30.00,13.80},proc=DAP_SetVarProc_CAA
	...
	TitleBox Title_Hardware_VC_gain,pos={106.80,394.80},size={17.40,12.00},title="gain"
	...
	TitleBox Title_Hardware_VC_unit,pos={183.00,394.80},size={15.00,12.00},title="unit"
	...
	TitleBox Title_Hardware_IC_gain,pos={288.60,394.80},size={17.40,12.00},title="gain"
	...
	TitleBox Title_Hardware_IC_unit,pos={345.00,394.80},size={15.00,12.00},title="unit"
	...
	TitleBox Title_DA_Unit,pos={105.00,49.80},size={24.00,15.00},disable=1,title="Unit"
	...
	SetVariable Unit_DA_01,pos={105.00,120.60},size={30.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Unit_DA_02,pos={105.00,166.80},size={30.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Unit_DA_03,pos={105.00,213.60},size={30.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Unit_DA_04,pos={105.00,259.80},size={30.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Unit_DA_05,pos={105.00,306.60},size={30.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Unit_DA_06,pos={105.00,352.80},size={30.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Unit_DA_07,pos={105.00,399.60},size={30.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState
	...
	SetVariable Unit_AD_00,pos={109.80,75.00},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_01,pos={109.80,120.60},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_02,pos={109.80,166.80},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_03,pos={109.80,213.60},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_04,pos={109.80,259.80},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_05,pos={109.80,306.60},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_06,pos={109.80,352.80},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_07,pos={109.80,399.60},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_08,pos={289.80,75.00},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_09,pos={289.80,120.60},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_10,pos={289.80,166.80},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_11,pos={289.80,213.60},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_12,pos={289.80,259.80},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_13,pos={289.80,306.60},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_14,pos={289.80,352.80},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	SetVariable Unit_AD_15,pos={289.80,399.60},size={39.60,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="V/"
	...
	TitleBox Title_AD_Unit,pos={121.80,49.80},size={24.00,15.00},disable=1,title="Unit"
	...
	TitleBox Title_AD_Gain,pos={54.60,49.80},size={24.60,15.00},disable=1,title="Gain"
	...
	TitleBox Title_AD_Channel,pos={24.60,49.80},size={16.80,15.00},disable=1,title="AD"
	...
	TitleBox Title_AD_Channel1,pos={195.00,49.80},size={16.80,15.00},disable=1,title="AD"
	...
	TitleBox Title_AD_Gain1,pos={232.80,49.80},size={24.60,15.00},disable=1,title="Gain"
	...
	TitleBox Title_AD_Unit1,pos={294.00,49.80},size={24.00,15.00},disable=1,title="Unit"
	...
	TitleBox Title_Hardware_VC_DA_Div,pos={198.60,414.60},size={11.40,12.00},title="/ V"
	...
	TitleBox Title_Hardware_IC_DA_Div,pos={375.60,414.60},size={11.40,12.00},title="/ V"
	...
	TitleBox Title_Hardware_IC_AD_Div,pos={348.60,439.80},size={11.40,12.00},title="V /"
	...
	TitleBox Title_Hardware_IC_AD_Div1,pos={166.80,439.80},size={11.40,12.00},title="V /"
	...
	GroupBox GroupBox_Hardware_Associations,pos={24.00,304.80},size={444.60,349.80},title="DAC Channel and Device Associations"
	...
	GroupBox group_Settings_DatAcq,pos={19.80,168.60},size={444.60,258.00},disable=1,title="Data Acquisition"
	...
	GroupBox group_Settings_Asynch,pos={21.00,430.80},size={444.60,90.00},disable=1,title="Asynchronous"
	...
	GroupBox group_Settings_TP,pos={21.00,67.80},size={444.60,99.60},disable=1,title="Test Pulse"
	...
	GroupBox group_Settings_Asynch1,pos={21.00,528.00},size={444.60,39.60},disable=1,title="Oscilloscope"
	...
	GroupBox group_DataAcq_ClampMode,pos={24.00,39.00},size={444.60,349.80},disable=1,title="Headstage"
	...
	GroupBox group_DataAcq_ClampMode1,pos={24.00,393.60},size={444.60,99.60},disable=1,title="Test Pulse"
	...
	GroupBox group_DataAcq_ClampMode2,pos={24.00,498.00},size={444.60,120.00},disable=1,title="Status Information"
	...
	TitleBox title_DataAcq_NextSweep,pos={210.60,513.00},size={70.80,18.60},disable=1,title="Next Sweep"
	...
	TitleBox title_DataAcq_NextSweep1,pos={334.80,540.00},size={78.60,18.60},disable=1,title="Total Sweeps"
	...
	TitleBox title_DataAcq_NextSweep2,pos={334.80,567.00},size={97.80,18.60},disable=1,title="Set Max Sweeps"
	...
	TitleBox title_DataAcq_NextSweep3,pos={181.80,591.60},size={132.00,18.60},disable=1,title="Sampling Interval (µs)"
	...
	GroupBox group_DataAcq_DataAcq,pos={24.00,621.60},size={445.80,228.00},disable=1,title="Data Acquisition"
	...
	GroupBox group_Hardware_Yoke,pos={24.00,154.80},size={444.60,144.60},title="Yoke"
	...
	Button button_Hardware_Lead1600,pos={28.80,195.00},size={79.80,21.00},disable=3,proc=DAP_ButtonProc_Lead,title="Lead"
	...
	PopupMenu popup_Hardware_AvailITC1600s,pos={0.00,240.00},size={201.00,18.60},bodyWidth=110,disable=3,title="Locked ITC1600s"
	...
	Button button_Hardware_AddFollower,pos={141.00,240.00},size={79.80,21.00},disable=3,proc=DAP_ButtonProc_Follow,title="Follow"
	...
	TitleBox title_hardware_1600inst,pos={28.80,175.80},size={306.60,15.00},disable=3,title="Designate the status of the ITC1600 assigned to this device"
	...
	Button button_Hardware_Independent,pos={111.00,195.00},size={79.80,21.00},disable=3,proc=DAP_ButtonProc_Independent,title="Independent"
	...
	SetVariable setvar_Hardware_Status,pos={168.00,852.00},size={166.80,13.80},bodyWidth=99,proc=DAP_SetVar_UpdateGuiState,title="ITC DAC Status:"
	...
	TitleBox title_hardware_Follow,pos={28.80,222.00},size={177.00,15.00},disable=3,title="Assign ITC1600 DACs as followers"
	...
	SetVariable setvar_Hardware_YokeList,pos={28.80,271.80},size={300.00,13.80},proc=DAP_SetVar_UpdateGuiState,title="Yoked DACs:"
	...
	Button button_Hardware_RemoveYoke,pos={334.80,240.00},size={79.80,21.00},disable=3,proc=DAP_ButtonProc_YokeRelease,title="Release"
	...
	PopupMenu popup_Hardware_YokedDACs,pos={222.60,240.00},size={109.80,18.60},bodyWidth=110,disable=3,title="Yoked ITC1600s"
	...
	TabControl tab_DataAcq_Amp,pos={31.80,147.60},size={424.80,120.00},disable=1,proc=ACL_DisplayTab
	...
	TitleBox Title_DataAcq_Hold_IC,pos={96.60,186.00},size={69.00,15.00},disable=1,title="Holding (pA)"
	...
	TitleBox Title_DataAcq_Bridge,pos={55.80,207.60},size={108.60,15.00},disable=1,title="Bridge Balance (MΩ)"
	...
	SetVariable setvar_DataAcq_Hold_IC,pos={166.80,184.80},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_AmpCntrls
	...
	SetVariable setvar_DataAcq_BB,pos={166.80,207.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_AmpCntrls
	...
	SetVariable setvar_DataAcq_CN,pos={166.80,231.00},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_AmpCntrls
	...
	CheckBox check_DatAcq_HoldEnable,pos={222.60,186.60},size={13.80,13.80},disable=1,proc=DAP_CheckProc_AmpCntrls,title=""
	...
	CheckBox check_DatAcq_BBEnable,pos={222.60,210.00},size={13.80,13.80},disable=1,proc=DAP_CheckProc_AmpCntrls,title=""
	...
	CheckBox check_DatAcq_CNEnable,pos={222.60,232.80},size={13.80,13.80},disable=1,proc=DAP_CheckProc_AmpCntrls,title=""
	...
	TitleBox Title_DataAcq_CN,pos={43.80,231.60},size={121.80,15.00},disable=1,title="Cap Neutralization (pF)"
	...
	Slider slider_DataAcq_ActiveHeadstage,pos={129.00,129.00},size={255.00,19.80},disable=1,proc=DAP_SliderProc_MIESHeadStage
	...
	SetVariable setvar_DataAcq_AutoBiasV,pos={286.80,217.80},size={100.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_AmpCntrls,title="Vm (mV)"
	...
	SetVariable setvar_DataAcq_IbiasMax,pos={297.60,240.60},size={135.60,19.80},bodyWidth=50,disable=1,proc=DAP_SetVarProc_AmpCntrls,title="max I \\Bbias\\M (pA) ±"
	...
	SetVariable setvar_DataAcq_AutoBiasVrange,pos={391.80,217.80},size={61.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_AmpCntrls,title="±"
	...
	TitleBox Title_DataAcq_Hold_VC,pos={0.60,208.80},size={49.80,19.80},disable=1
	...
	SetVariable setvar_DataAcq_Hold_VC,pos={42.00,172.80},size={93.00,18.00},bodyWidth=46,disable=1,proc=DAP_SetVarProc_AmpCntrls,title="Holding"
	...
	TitleBox Title_DataAcq_PipOffset_VC,pos={244.80,175.80},size={100.80,15.00},disable=1,title="Pipette Offset (mV)"
	...
	SetVariable setvar_DataAcq_PipetteOffset_VC,pos={348.00,174.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_AmpCntrls
	...
	Button button_DataAcq_AutoPipOffset_VC,pos={400.80,174.60},size={39.60,19.80},disable=1,proc=DAP_ButtonProc_AmpCntrls,title="Auto"
	...
	GroupBox group_pipette_offset_VC,pos={237.60,171.00},size={210.00,27.60},disable=1
	...
	GroupBox group_pipette_offset_IC,pos={243.60,171.00},size={210.00,27.60},disable=1
	...
	Button button_DataAcq_AutoPipOffset_IC,pos={406.80,174.60},size={39.60,19.80},disable=1,proc=DAP_ButtonProc_AmpCntrls,title="Auto"
	...
	TitleBox Title_DataAcq_PipOffset_IC,pos={250.80,175.80},size={100.80,15.00},disable=1,title="Pipette Offset (mV)"
	...
	SetVariable setvar_DataAcq_PipetteOffset_IC,pos={354.00,174.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_AmpCntrls
	...
	CheckBox check_DatAcq_HoldEnableVC,pos={141.60,174.00},size={51.00,15.00},disable=1,proc=DAP_CheckProc_AmpCntrls,title="Enable"
	...
	SetVariable setvar_DataAcq_WCR,pos={111.60,219.00},size={73.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_AmpCntrls,title="MΩ"
	...
	CheckBox check_DatAcq_WholeCellEnable,pos={63.00,198.60},size={13.80,13.80},disable=1,proc=DAP_CheckProc_AmpCntrls,title=""
	...
	SetVariable setvar_DataAcq_WCC,pos={42.60,219.60},size={66.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_AmpCntrls,title="pF"
	...
	Button button_DataAcq_WCAuto,pos={96.60,238.80},size={39.60,15.00},disable=1,proc=DAP_ButtonProc_AmpCntrls,title="Auto"
	...
	GroupBox group_DataAcq_RsCompensation,pos={199.80,199.80},size={184.80,61.80},disable=1,title="       Rs Compensation"
	...
	CheckBox check_DatAcq_RsCompEnable,pos={222.60,198.60},size={13.80,13.80},disable=1,proc=DAP_CheckProc_AmpCntrls,title=""
	...
	SetVariable setvar_DataAcq_RsCorr,pos={205.80,217.80},size={120.60,18.00},bodyWidth=40,disable=1,proc=DAP_SetVarProc_AmpCntrls,title="Correction (%)"
	...
	SetVariable setvar_DataAcq_RsPred,pos={207.60,237.60},size={118.80,18.00},bodyWidth=40,disable=1,proc=DAP_SetVarProc_AmpCntrls,title="Prediction (%)"
	...
	Button button_DataAcq_FastComp_VC,pos={393.60,213.60},size={54.60,19.80},disable=1,proc=DAP_ButtonProc_AmpCntrls,title="Cp Fast"
	...
	Button button_Hardware_AutoGainAndUnit,pos={399.00,408.60},size={39.60,46.80},proc=DAP_ButtonProc_AutoFillGain,title="Auto\rFill"
	...
	CheckBox Check_Settings_AlarmPauseAcq,pos={33.60,474.00},size={181.80,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="\\JCPause acquisition in alarm state"
	...
	CheckBox Check_Settings_AlarmAutoRepeat,pos={33.60,495.00},size={274.80,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Auto repeat last sweep until alarm state is cleared"
	...
	GroupBox group_Settings_Amplifier,pos={21.00,573.60},size={444.00,99.60},disable=1,title="Amplifier"
	...
	CheckBox check_Settings_AmpMCCdefault,pos={33.60,591.60},size={190.80,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Default to MCC parameter values"
	...
	CheckBox check_Settings_SyncMiesToMCC,pos={33.60,612.60},size={153.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Synchronize MIES to MCC"
	...
	CheckBox check_DataAcq_Amp_Chain,pos={330.60,229.80},size={46.80,15.00},disable=1,proc=DAP_CheckProc_AmpCntrls,title="Chain"
	...
	GroupBox group_Settings_MDSupport,pos={21.00,25.80},size={444.60,39.60},disable=1,title="Multiple Device Support"
	...
	CheckBox check_Settings_MD,pos={33.60,43.80},size={51.00,15.00},disable=1,proc=DAP_CheckProc_MDEnable,title="Enable"
	...
	CheckBox Check_Settings_InsertTP,pos={171.60,84.60},size={61.80,15.00},disable=1,proc=DAP_CheckProc_InsertTP,title="Insert TP"
	...
	SetVariable setvar_Settings_TPBuffer,pos={324.60,108.60},size={124.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="TP Buffer size"
	...
	CheckBox check_Settings_SaveAmpSettings,pos={325.80,597.00},size={114.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Save Amp Settings"
	...
	SetVariable setvar_Settings_TP_RTolerance,pos={304.80,84.00},size={144.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="Min delta R (MΩ)"
	...
	CheckBox check_Settings_TP_SaveTPRecord,pos={342.00,132.60},size={93.60,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Save TP record"
	...
	Button button_DataAcq_AutoBridgeBal_IC,pos={240.00,208.80},size={39.60,15.00},disable=1,proc=DAP_ButtonProc_AmpCntrls,title="Auto"
	...
	Button button_DataAcq_Seal,pos={147.00,298.80},size={84.00,27.00},disable=3,proc=ButtonProc_Seal,title="Seal"
	...
	Button button_DataAcq_BreakIn,pos={256.80,298.80},size={84.00,27.00},disable=3,proc=ButtonProc_BreakIn,title="Break In"
	...
	Button button_DataAcq_Clear,pos={366.60,298.80},size={84.00,27.00},disable=3,proc=ButtonProc_Clear,title="Clear"
	...
	CheckBox check_DatAcq_ClearEnable,pos={369.60,328.80},size={49.80,15.00},disable=3,proc=CheckProc_ClearEnable,title="Enable"
	...
	CheckBox check_DatAcq_SealALl,pos={150.00,328.80},size={28.80,15.00},disable=3,proc=DAP_CheckProc_UpdateGuiState,title="All"
	...
	CheckBox check_DatAcq_BreakInAll,pos={259.80,328.80},size={28.80,15.00},disable=3,proc=DAP_CheckProc_UpdateGuiState,title="All"
	...
	Button button_DataAcq_Approach,pos={36.60,298.80},size={84.00,27.00},disable=3,proc=ButtonProc_Approach,title="Approach"
	...
	CheckBox check_DatAcq_ApproachAll,pos={40.80,328.80},size={28.80,15.00},disable=3,proc=DAP_CheckProc_UpdateGuiState,title="All"
	...
	PopupMenu popup_Settings_Pressure_dev,pos={62.40,495.00},size={201.60,14.40},bodyWidth=150,proc=DAP_PopMenuProc_CAA,title="DAC devices"
	...
	TitleBox Title_settings_Hardware_Pressur,pos={45.00,474.60},size={32.40,12.00},title="Pressure"
	...
	PopupMenu Popup_Settings_Pressure_DA,pos={49.80,528.60},size={32.40,14.40},proc=DAP_PopMenuProc_CAA,title="DA"
	...
	PopupMenu Popup_Settings_Pressure_AD,pos={49.80,555.00},size={32.40,14.40},proc=DAP_PopMenuProc_CAA,title="AD"
	...
	SetVariable setvar_Settings_Pressure_DAgain,pos={111.00,528.60},size={49.80,13.80},proc=DAP_SetVarProc_CAA
	...
	SetVariable setvar_Settings_Pressure_ADgain,pos={111.00,555.60},size={49.80,13.80},proc=DAP_SetVarProc_CAA
	...
	SetVariable SetVar_Hardware_Pressur_DA_Unit,pos={168.60,528.60},size={30.00,13.80},proc=DAP_SetVarProc_CAA
	...
	SetVariable SetVar_Hardware_Pressur_AD_Unit,pos={189.60,555.60},size={30.00,13.80},proc=DAP_SetVarProc_CAA
	...
	TitleBox Title_Hardware_Pressure_DA_Div,pos={202.80,528.60},size={11.40,12.00},title="/ V"
	...
	TitleBox Title_Hardware_Pressure_AD_Div,pos={171.00,556.80},size={11.40,12.00},title="V /"
	...
	PopupMenu Popup_Settings_Pressure_TTLA,pos={238.20,528.60},size={93.60,14.40},bodyWidth=70,proc=DAP_PopMenuProc_CAA,title="TTL A"
	...
	GroupBox group_Settings_Pressure,pos={24.00,676.80},size={444.00,99.60},disable=1,title="Pressure"
	...
	SetVariable setvar_Settings_InAirP,pos={48.00,696.60},size={115.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="In air P (psi)"
	...
	SetVariable setvar_Settings_InBathP,pos={171.60,697.80},size={126.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="In bath P (psi)"
	...
	SetVariable setvar_Settings_InSliceP,pos={325.80,697.80},size={126.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="In slice P (psi)"
	...
	SetVariable setvar_Settings_NearCellP,pos={27.60,723.60},size={135.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="Near cell P (psi)"
	...
	SetVariable setvar_Settings_SealStartP,pos={168.00,724.80},size={130.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="Seal Init P (psi)"
	...
	SetVariable setvar_Settings_SealMaxP,pos={315.60,724.80},size={135.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="Seal max P (psi)"
	...
	SetVariable setvar_Settings_SurfaceHeight,pos={27.60,750.60},size={135.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="Sol surface\\Z11 (µm)"
	...
	SetVariable setvar_Settings_SliceSurfHeight,pos={168.00,750.60},size={144.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="Slice surface\\Z11 (µm)"
	...
	Button button_Settings_UpdateDACList,pos={270.60,493.80},size={190.80,21.60},proc=ButtonProc_Hrdwr_P_UpdtDAClist,title="Query connected DAC(s)"
	...
	Button button_Hardware_P_Enable,pos={336.60,528.60},size={60.00,45.60},proc=P_ButtonProc_Enable,title="Enable"
	...
	Button button_Hardware_P_Disable,pos={400.80,528.60},size={60.00,45.60},disable=2,proc=P_ButtonProc_Disable,title="Disable"
	...
	ValDisplay valdisp_DataAcq_P_0,pos={45.60,351.00},size={99.00,21.00},bodyWidth=35,disable=1,title="\\Z10Pressure (psi) "
	...
	ValDisplay valdisp_DataAcq_P_1,pos={153.00,351.00},size={34.80,21.00},bodyWidth=35,disable=1
	...
	ValDisplay valdisp_DataAcq_P_2,pos={195.60,351.00},size={34.80,21.00},bodyWidth=35,disable=1
	...
	ValDisplay valdisp_DataAcq_P_4,pos={282.00,351.00},size={34.80,21.00},bodyWidth=35,disable=1
	...
	ValDisplay valdisp_DataAcq_P_5,pos={324.60,351.00},size={34.80,21.00},bodyWidth=35,disable=1
	...
	ValDisplay valdisp_DataAcq_P_6,pos={367.80,351.00},size={34.80,21.00},bodyWidth=35,disable=1
	...
	ValDisplay valdisp_DataAcq_P_7,pos={411.00,351.00},size={34.80,21.00},bodyWidth=35,disable=1
	...
	TabControl tab_DataAcq_Pressure,pos={31.80,271.80},size={424.80,109.80},disable=1,proc=ACL_DisplayTab
	...
	Button button_DataAcq_SSSetPressureMan,pos={39.00,301.80},size={84.00,27.00},disable=3,proc=ButtonProc_DataAcq_ManPressSet,title="Apply"
	...
	Button button_DataAcq_PPSetPressureMan,pos={199.80,301.80},size={90.00,27.00},disable=1,proc=ButtonProc_ManPP,title="Pressure Pulse"
	...
	SetVariable setvar_DataAcq_SSPressure,pos={124.80,306.60},size={69.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="psi"
	...
	SetVariable setvar_DataAcq_PPPressure,pos={291.00,306.60},size={69.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_CAA,title="psi"
	...
	SetVariable setvar_DataAcq_PPDuration,pos={361.80,306.60},size={87.00,18.00},bodyWidth=40,disable=1,proc=DAP_SetVarProc_CAA,title="Dur(ms)"
	...
	CheckBox check_DataAcq_ManPressureAll,pos={69.00,331.80},size={30.00,15.00},disable=3,proc=DAP_CheckProc_UpdateGuiState,title="All"
	...
	CheckBox check_settings_TP_show_peak,pos={33.60,132.00},size={127.80,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Show peak resistance"
	...
	CheckBox check_settings_TP_show_steady,pos={171.60,132.60},size={165.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Show steady state resistance"
	...
	CheckBox check_DatAcq_ApproachNear,pos={79.80,328.80},size={39.60,15.00},disable=1,proc=P_Check_ApproachNear,title="Near"
	...
	Button button_DataAcq_SlowComp_VC,pos={393.60,235.80},size={54.60,19.80},disable=1,proc=DAP_ButtonProc_AmpCntrls,title="Cp Slow"
	...
	CheckBox check_DatAcq_SealAtm,pos={186.00,328.80},size={40.80,15.00},disable=1,proc=P_Check_SealAtm,title="Atm."
	...
	CheckBox Check_DataAcq1_DistribDaq,pos={141.60,643.80},size={100.80,15.00},disable=1,proc=DAP_CheckProc_SyncCtrl,title="distributed DAQ"
	...
	CheckBox Check_DataAcq1_dDAQOptOv,pos={157.80,660.00},size={61.80,15.00},bodyWidth=50,disable=1,proc=DAP_CheckProc_SyncCtrl,title="oodDAQ"
	...
	SetVariable Setvar_DataAcq_dDAQDelay,pos={319.80,676.80},size={144.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_SyncCtrl,title="dDAQ delay (ms)"
	...
	SetVariable setvar_DataAcq_dDAQOptOvPost,pos={279.60,715.80},size={183.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_SyncCtrl,title="oodDAQ post delay (ms)"
	...
	SetVariable setvar_DataAcq_dDAQOptOvPre,pos={285.60,696.00},size={177.60,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_SyncCtrl,title="oodDAQ pre delay (ms)"
	...
	Button button_DataAcq_OpenCommentNB,pos={409.80,778.80},size={36.00,18.60},disable=1,proc=DAP_ButtonProc_OpenCommentNB,title="NB"
	...
	CheckBox check_Settings_TPAfterDAQ,pos={171.60,108.60},size={130.80,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Activate TP after DAQ"
	...
	SetVariable setvar_DataAcq_OnsetDelayUser,pos={297.00,637.80},size={166.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVar_UpdateGuiState,title="User onset delay (ms)"
	...
	ValDisplay valdisp_DataAcq_OnsetDelayAuto,pos={321.00,756.00},size={142.80,16.80},bodyWidth=50,disable=1,title="Onset delay (ms)"
	...
	Button button_Hardware_ClearChanConn,pos={274.80,328.80},size={150.00,19.80},proc=DAP_ButtonProc_ClearChanCon,title="Clear Associations"
	...
	CheckBox check_Settings_DisablePressure,pos={321.00,747.60},size={132.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Stop pressure on DAQ"
	...
	CheckBox check_Settings_AmpIEQZstep,pos={325.80,640.80},size={121.80,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Mode switch via I=0"
	...
	CheckBox check_Settings_RequireAmpConn,pos={324.60,618.60},size={108.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Require Amplifier"
	...
	CheckBox Check_AD_All,pos={18.60,436.80},size={21.60,15.00},disable=1,proc=DAP_CheckProc_Channel_All,title="X"
	...
	GroupBox Group_AD_all,pos={19.80,427.80},size={309.60,3.60},disable=1
	...
	CheckBox Check_DA_ALL,pos={18.60,460.80},size={22.80,15.00},disable=1,proc=DAP_CheckProc_Channel_All,title="X"
	...
	PopupMenu Wave_DA_All,pos={153.00,457.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	SetVariable Search_DA_All,pos={153.00,481.80},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Scale_DA_All,pos={289.80,457.80},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_DA_Scale
	...
	PopupMenu IndexEnd_DA_All,pos={352.80,457.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	GroupBox Group_TTL_all,pos={19.80,447.00},size={345.00,4.80},disable=1
	...
	PopupMenu Wave_TTL_All,pos={102.60,459.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	SetVariable Search_TTL_All,pos={102.60,481.80},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	PopupMenu IndexEnd_TTL_All,pos={243.00,459.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	CheckBox Check_TTL_ALL,pos={19.80,460.80},size={21.60,15.00},disable=1,proc=DAP_CheckProc_Channel_All,title="X"
	...
	CheckBox check_settings_show_power,pos={168.60,546.00},size={133.80,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Show power spectrum"
	...
	SetVariable setvar_DataAcq_dDAQOptOvRes,pos={280.80,735.00},size={183.00,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_SyncCtrl,title="oodDAQ resolution (ms)"
	...
	PopupMenu Popup_Settings_Pressure_TTLB,pos={238.20,555.00},size={93.00,14.40},bodyWidth=70,proc=DAP_PopMenuProc_CAA,title="TTL B"
	...
	CheckBox check_Settings_UserP_Approach,pos={229.80,321.00},size={66.60,15.00},disable=1,proc=DAP_CheckProc_Settings_PUser,title="Approach"
	...
	CheckBox check_Settings_UserP_BreakIn,pos={342.60,321.00},size={61.80,15.00},disable=1,proc=DAP_CheckProc_Settings_PUser,title="Break-In "
	...
	CheckBox check_Settings_UserP_Clear,pos={406.80,321.00},size={42.00,15.00},disable=1,proc=DAP_CheckProc_Settings_PUser,title="Clear"
	...
	TitleBox title_Settings_Pressure_UserP,pos={226.80,301.80},size={124.80,15.00},disable=1,title="User pressure in modes:"
	...
	CheckBox check_DataACq_Pressure_User,pos={193.80,274.80},size={78.60,15.00},disable=1,proc=DAP_CheckProc_Settings_PUser,title=" User access"
	...
	CheckBox check_DataACq_Pressure_AutoOFF,pos={105.60,321.00},size={90.60,15.00},disable=1,proc=DAP_CheckProc_Settings_PUser,title="Auto User OFF"
	...
	CheckBox Check_DA_AllVClamp,pos={18.60,543.00},size={22.80,15.00},disable=1,proc=DAP_CheckProc_Channel_All,title="X"
	...
	PopupMenu Wave_DA_AllVClamp,pos={153.00,544.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	SetVariable Search_DA_AllVClamp,pos={153.60,568.80},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Scale_DA_AllVClamp,pos={288.00,544.80},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_DA_Scale
	...
	PopupMenu IndexEnd_DA_AllVClamp,pos={352.80,544.80},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	CheckBox Check_DA_AllIClamp,pos={18.60,625.80},size={22.80,15.00},disable=1,proc=DAP_CheckProc_Channel_All,title="X"
	...
	PopupMenu Wave_DA_AllIClamp,pos={153.00,627.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	SetVariable Search_DA_AllIClamp,pos={153.60,651.60},size={123.60,18.00},disable=1,proc=DAP_SetVarProc_Channel_Search,title="Search string"
	...
	SetVariable Scale_DA_AllIClamp,pos={288.00,627.60},size={49.80,18.00},bodyWidth=50,disable=1,proc=DAP_SetVarProc_DA_Scale
	...
	PopupMenu IndexEnd_DA_AllIClamp,pos={354.00,627.60},size={124.80,18.60},bodyWidth=125,disable=1,proc=DAP_PopMenuChkProc_StimSetList
	...
	CheckBox Radio_ClampMode_AllVClamp,pos={399.60,61.80},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_AllIClamp,pos={399.60,111.00},size={13.80,13.80},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Radio_ClampMode_AllIZero,pos={400.80,180.60},size={12.60,12.60},disable=1,proc=DAP_CheckProc_ClampMode,title=""
	...
	CheckBox Check_DataAcqHS_All,pos={399.60,84.60},size={30.00,15.00},disable=1,proc=DAP_CheckProc_HedstgeChck,title="All"
	...
	CheckBox check_Settings_TP_SaveTP,pos={342.00,150.00},size={117.60,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Save each testpulse"
	...
	Button Button_DataAcq_SkipForward,pos={342.60,589.80},size={49.80,19.80},disable=1,proc=DAP_ButtonProc_skipSweep,title="Skip\\Z12 >>"
	...
	Button Button_DataAcq_SkipBackwards,pos={105.00,589.80},size={49.80,19.80},disable=1,proc=DAP_ButtonProc_skipBack,title="<<Skip"
	...
	SetVariable SetVar_DataAcq_skipAhead,pos={43.80,720.60},size={96.00,33.00},bodyWidth=35,disable=1,proc=DAP_SetVarProc_skipAhead,title="Skip ahead\r(sweeps)"
	...
	CheckBox check_DA_applyOnModeSwitch,pos={346.80,691.80},size={135.00,15.00},disable=1,proc=DAP_CheckProc_UpdateGuiState,title="Apply on mode switch"
	...
	SetVariable setvar_Settings_AutoBiasPerc,pos={76.80,630.00},size={111.00,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Autobias (%)"
	...
	SetVariable setvar_Settings_AutoBiasInt,pos={30.00,649.80},size={157.80,18.00},disable=1,proc=DAP_SetVar_UpdateGuiState,title="Autobias interval (s)"
