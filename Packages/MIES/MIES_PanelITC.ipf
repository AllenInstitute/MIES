...
Window DA_Ephys() : Panel
	...
	CheckBox check_Settings_UserP_BreakIn,help={"User access during Break-in - pressure is set to atmospheric when the steady state resistance drops below 1 GÎ©"}
