...
StrConstant MSQ_FMT_LBN_SPIKE_COUNTS         = "%s spike count"
...
StrConstant MSQ_FMT_LBN_SPIKE_POSITION_PASS  = "%s Spike position state"
StrConstant MSQ_FMT_LBN_SPIKE_COUNTS_CHECK   = "%s Spike counts check"
