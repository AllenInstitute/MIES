...
StrConstant PSQ_FMT_LBN_DA_AT_FREQ_RH_SUPRA_ADAPT    = "%s AP frequency from rheobase, supra, adaptive"
...
StrConstant PSQ_FMT_LBN_DA_AT_DASCALE_RH_SUPRA_ADAPT = "%s DAScale from rheobase, supra, adaptive"
StrConstant PSQ_FMT_LBN_DA_AT_FI_SLOPES              = "%s f-I slopes from rheobase, supra, adaptive"
StrConstant PSQ_FMT_LBN_DA_AT_FI_OFFSETS             = "%s f-I offsets from rheobase, supra, adaptive"
...
StrConstant PSQ_FMT_LBN_DA_AT_INIT_VALID_SLOPE_PASS  = "%s f-I initial slope valid from rheobase, supra, adaptive QC"
