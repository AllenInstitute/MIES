...
Window AnalysisBrowser() : Panel
	...
	Button button_select_same_stim_sets, pos={7.00, 172.00}, size={100.00, 30.00}, proc=AB_ButtonProc_SelectStimSets
	...
	Button button_select_same_stim_sets, userdata(ResizeControlsInfo)=A"!!,@C!!#A;!!#@,!!#=Sz!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	Button button_collapse_all, pos={7.00, 205.00}, size={100.00, 25.00}, proc=AB_ButtonProc_CollapseAll
	...
	Button button_collapse_all, userdata(ResizeControlsInfo)=A"!!,@C!!#A\\!!#@,!!#=+z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	Button button_expand_all, pos={7.00, 233.00}, size={100.00, 25.00}, proc=AB_ButtonProc_ExpandAll
	...
	Button button_load_sweeps, pos={7.00, 359.00}, size={100.00, 25.00}, proc=AB_ButtonProc_LoadSweeps
	...
	Button button_load_sweeps, userdata(ResizeControlsInfo)=A"!!,@C!!#BmJ,hpW!!#=+z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	Button button_load_stimsets, pos={7.00, 387.00}, size={100.00, 25.00}, proc=AB_ButtonProc_LoadStimsets
	...
	Button button_load_stimsets, userdata(ResizeControlsInfo)=A"!!,@C!!#C&J,hpW!!#=+z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	Button button_show_usercomments, pos={7.00, 261.00}, size={100.00, 25.00}, proc=AB_ButtonProc_OpenCommentNB
	...
	Button button_show_usercomments, userdata(ResizeControlsInfo)=A"!!,@C!!#B<J,hpW!!#=+z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	CheckBox checkbox_load_overwrite, pos={19.00, 330.00}, size={67.00, 15.00}
	...
	CheckBox checkbox_load_overwrite, userdata(ResizeControlsInfo)=A"!!,BQ!!#B_!!#??!!#<(z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	Button button_show_resaveAsNWB, pos={8.00, 301.00}, size={100.00, 25.00}, proc=AB_ButtonProc_ResaveAsNWB
	...
	Button button_show_resaveAsNWB, userdata(ResizeControlsInfo)=A"!!,@c!!#BPJ,hpW!!#=+z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	ListBox listbox_AB_Folders, pos={120.00, 4.00}, size={1272.00, 151.00}
	ListBox listbox_AB_Folders, help={"Source folders for sweep/stimset files"}
	ListBox listbox_AB_Folders, userdata(ResizeControlsInfo)=A"!!,FU!!#97!!#EZ!!#A&z!!#](Aon\"Qzzzzzzzzzzzzzz!!#o2B4uAezz"
	...
	Button button_load_sweepsAndStimsets, pos={7.00, 415.00}, size={100.00, 25.00}, proc=AB_ButtonProc_LoadBoth
	...
	Button button_load_sweepsAndStimsets, userdata(ResizeControlsInfo)=A"!!,@C!!#C4J,hpW!!#=+z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	Button button_load_tpstorage, pos={7.00, 451.00}, size={100.00, 25.00}, proc=AB_ButtonProc_LoadTPStorage
	...
	Button button_load_tpstorage, userdata(ResizeControlsInfo)=A"!!,@C!!#CFJ,hpW!!#=+z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	GroupBox group1, pos={4.00, 295.00}, size={111.00, 57.00}
	GroupBox group1, userdata(ResizeControlsInfo)=A"!!,?8!!#BMJ,hpm!!#>rz!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	GroupBox group2, pos={4.00, 354.00}, size={111.00, 127.00}
	...
	Execute/Q/Z "SetWindow kwTopWin sizeLimit={1049.25,663,inf,inf}" // sizeLimit requires Igor 7 or later
EndMacro
