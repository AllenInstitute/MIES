...
Window da_ephys() : Panel
	...
	PopupMenu Wave_DA_01,mode=2,popvalue="TestPulse",value= #"\"- none -;TestPulse;\"+WBP_ITCPanelPopUps(0,\"*da*\")"
	...
	SetVariable SetVar_DataAcq_Comment,pos={48,671},size={384,16},disable=1,title="Comment"
	...
	Button DataAcquireButton,pos={44,691},size={389,40},disable=1,proc=DAP_ButtonProc_AcquireDataMD,title="\\Z14\\f01Acquire\rData"
	...
	CheckBox Check_DataAcq1_RepeatAcq,pos={38,582},size={119,14},disable=1,proc=DAP_CheckProc_RepeatedAcq,title="Repeated Acquisition"
	...
	SetVariable SetVar_DataAcq_ITI,pos={87,638},size={77,16},bodyWidth=35,disable=3,proc=DAP_SetVarProc_ITI,title="\\JCITl (sec)"
	...
	Button StartTestPulseButton,pos={51,383},size={384,40},disable=1,proc=TP_ButtonProc_DataAcq_TPMD,title="\\Z14\\f01Start Test \rPulse"
	...
	SetVariable SetVar_DataAcq_TPDuration,pos={66,363},size={110,16},disable=1,proc=DAP_SetVarProc_TPDuration,title="Duration (ms)"
	...
	SetVariable SetVar_DataAcq_TPAmplitude,pos={194,363},size={100,16},disable=1,title="Amplitude VC"
	...
	SetVariable SetVar_DataAcq_SetRepeats,pos={60,618},size={104,16},bodyWidth=35,disable=1,proc=DAP_SetVarProc_TotSweepCount,title="Repeat Set(s)"
	...
	ValDisplay ValDisp_DataAcq_SamplingInt,pos={218,517},size={30,17},bodyWidth=30,disable=1
	...
	SetVariable SetVar_Sweep,pos={200,475},size={75,32},bodyWidth=75,disable=1,proc=DAP_SetVarProc_NextSweepLimit
	...
	SetVariable SetVar_Sweep,valueBackColor=(0,0,0),limits={0,16,1},value= _NUM:0
	...
	SetVariable setvar_Settings_IC_ADgain,value= _NUM:0.000500000023748726
	...
	Button button_Settings_UpdateAmpStatus,pos={262,358},size={150,20},proc=DAP_FindConnectedAmps,title="Query connected Amp(s)"
	...
	CheckBox Check_DataAcq_Indexing,pos={178,598},size={58,14},disable=1,proc=DAP_CheckProc_IndexingState,title="Indexing"
	...
	ValDisplay valdisp_DataAcq_ITICountdown,pos={60,509},size={129,17},bodyWidth=30,disable=1,title="ITI remaining (s)"
	...
	ValDisplay valdisp_DataAcq_TrialsCountdown,pos={45,482},size={145,17},bodyWidth=30,disable=1,title="Sweeps remaining"
	...
	CheckBox check_DataAcq_RepAcqRandom,pos={72,598},size={58,14},disable=1,title="Random"
	...
	SetVariable setvar_DataAcq_OnsetDelay,pos={315,584},size={117,16},bodyWidth=35,disable=1,title="Onset delay (ms)"
	...
	SetVariable setvar_DataAcq_TerminationDelay,pos={288,605},size={144,16},bodyWidth=35,disable=1,title="Termination delay (ms)"
	...
	ValDisplay valdisp_DataAcq_SweepsInSet,pos={287,482},size={30,17},bodyWidth=30,disable=1
	...
	CheckBox Check_DataAcq1_IndexingLocked,pos={204,632},size={54,14},disable=1,proc=DAP_CheckProc_IndexingState,title="Locked"
	...
	SetVariable SetVar_DataAcq_ListRepeats,pos={178,648},size={104,16},bodyWidth=35,disable=1,proc=DAP_SetVarProc_TotSweepCount,title="Repeat List(s)"
	...
	CheckBox check_DataAcq_IndexRandom,pos={204,615},size={58,14},disable=1,title="Random"
	...
	SetVariable setvar_DataAcq_FirstStepOveride,pos={349,626},size={83,16},bodyWidth=35,disable=1,title="First Step"
	...
	SetVariable setvar_DataAcq_TotalStepOveride,pos={339,648},size={93,16},bodyWidth=35,disable=1,title="Total Steps"
	...
	ValDisplay valdisp_DataAcq_SweepsActiveSet,pos={287,509},size={30,17},bodyWidth=30,disable=1
	...
	SetVariable SetVar_DataAcq_TPAmplitudeIC,pos={316,363},size={105,16},disable=1,title="Amplitude IC"
	...
	GroupBox group_DataAcq_ClampMode,pos={30,39},size={422,300},disable=1,title="Headstage"
	GroupBox group_DataAcq_ClampMode,userdata(tabnum)=  "0"
	GroupBox group_DataAcq_ClampMode,userdata(tabcontrol)=  "ADC"
	GroupBox group_DataAcq_ClampMode1,pos={30,345},size={422,90},disable=1,title="Test Pulse"
	GroupBox group_DataAcq_ClampMode1,userdata(tabnum)=  "0"
	GroupBox group_DataAcq_ClampMode1,userdata(tabcontrol)=  "ADC"
	GroupBox group_DataAcq_ClampMode2,pos={30,441},size={422,115},disable=1,title="Status Information"
	GroupBox group_DataAcq_ClampMode2,userdata(tabnum)=  "0"
	GroupBox group_DataAcq_ClampMode2,userdata(tabcontrol)=  "ADC"
	TitleBox title_DataAcq_NextSweep,pos={200,456},size={72,16},disable=1,title="Next Sweep"
	...
	TitleBox title_DataAcq_NextSweep1,pos={324,483},size={83,16},disable=1,title="Total Sweeps"
	...
	TitleBox title_DataAcq_NextSweep2,pos={324,510},size={100,16},disable=1,title="Set Max Sweeps"
	...
	TitleBox title_DataAcq_NextSweep3,pos={171,535},size={128,16},disable=1,title="Sampling Interval (µs)"
	...
	GroupBox group_DataAcq_DataAcq,pos={30,564},size={422,175},disable=1,title="Data Acquisition"
	...
	SetVariable setvar_Hardware_Status,pos={145,742},size={196,16},bodyWidth=99,title="ITC DAC Status:"
	...
	SetVariable setvar_DataAcq_RsCorr,limits={0,100,1},value= _NUM:45
	...
	SetVariable setvar_DataAcq_RsPred,limits={0,100,1},value= _NUM:31
	...
	SetVariable setvar_Settings_TPBuffer,limits={1,inf,1},value= _NUM:15
	...
	Button button_DataAcq_Seal,pos={145,263},size={84,27},disable=3,proc=ButtonProc_Seal,title="Seal"
	Button button_DataAcq_Seal,help={"Sets the I-clamp holding current based on the V-clamp holding potential"}
	Button button_DataAcq_Seal,userdata(tabnum)=  "0",userdata(tabcontrol)=  "ADC"
	Button button_DataAcq_BreakIn,pos={251,263},size={84,27},disable=3,proc=ButtonProc_BreakIn,title="Break In"
	...
	Button button_DataAcq_BreakIn,userdata(tabcontrol)=  "ADC"
	Button button_DataAcq_Clear,pos={358,263},size={84,27},disable=3,proc=ButtonProc_Clear,title="Clear"
	Button button_DataAcq_Clear,help={"Attempts to clear the pipette tip to improve access resistance"}
	Button button_DataAcq_Clear,userdata(tabnum)=  "0",userdata(tabcontrol)=  "ADC"
	CheckBox check_DatAcq_ClearEnable,pos={372,293},size={51,14},disable=3,proc=CheckProc_ClearEnable,title="Enable"
	CheckBox check_DatAcq_ClearEnable,userdata(tabnum)=  "0"
	CheckBox check_DatAcq_ClearEnable,userdata(tabcontrol)=  "ADC",value= 0
	CheckBox check_DatAcq_SealALl,pos={164,293},size={29,14},disable=3,proc=CheckProc_SealAll,title="All"
	...
	CheckBox check_DatAcq_SealALl,userdata(tabcontrol)=  "ADC",value= 0
	CheckBox check_DatAcq_BreakInAll,pos={273,293},size={29,14},disable=3,proc=CheckProc_BreakInAll,title="All"
	...
	CheckBox check_DatAcq_BreakInAll,userdata(tabcontrol)=  "ADC",value= 0
	Button button_DataAcq_Approach,pos={39,263},size={84,27},disable=3,proc=ButtonProc_Approach,title="Approach"
	...
	Button button_DataAcq_Approach,userdata(tabcontrol)=  "ADC"
	CheckBox check_DatAcq_ApproachAll,pos={55,293},size={29,14},disable=3,proc=CheckProc_ApproachAll,title="All"
	...
	CheckBox check_DatAcq_ApproachAll,userdata(tabcontrol)=  "ADC",value= 1
	...
	PopupMenu popup_Settings_Pressure_ITCdev,mode=2,popvalue="ITC1600_Dev_2",value= #"\"- none -;ITC1600_Dev_2;ITC1600_Dev_3;\""
	...
	SetVariable setvar_Settings_InAirP,pos={59,618},size={92,16},disable=1,title="In air P (psi)"
	...
	SetVariable setvar_Settings_InAirP,limits={-10,10,0.1},value= _NUM:0.600000023841858
	SetVariable setvar_Settings_InBathP,pos={162,618},size={105,16},disable=1,title="In bath P (psi)"
	...
	SetVariable setvar_Settings_InBathP,limits={-10,10,0.1},value= _NUM:0.600000023841858
	...
	SetVariable setvar_Settings_InSliceP,limits={-10,10,0.1},value= _NUM:0.600000023841858
	...
	SetVariable setvar_Settings_NearCellP,limits={-1,1,0.1},value= _NUM:0.200000002980232
	...
	SetVariable setvar_Settings_SealMaxP,limits={-10,0,0.1},value= _NUM:-1.29999995231628
	...
	ValDisplay valdisp_DataAcq_P_0,pos={53,316},size={102,17},bodyWidth=35,disable=1,title="\\Z10Pressure (psi)"
	ValDisplay valdisp_DataAcq_P_0,userdata(tabnum)=  "0"
	ValDisplay valdisp_DataAcq_P_0,userdata(tabcontrol)=  "ADC",fSize=14,fStyle=0
	...
	ValDisplay valdisp_DataAcq_P_1,pos={158,316},size={35,17},bodyWidth=35,disable=1
	ValDisplay valdisp_DataAcq_P_1,userdata(tabnum)=  "0"
	ValDisplay valdisp_DataAcq_P_1,userdata(tabcontrol)=  "ADC",fSize=14,fStyle=0
	...
	ValDisplay valdisp_DataAcq_P_2,pos={198,316},size={35,17},bodyWidth=35,disable=1
	ValDisplay valdisp_DataAcq_P_2,userdata(tabnum)=  "0"
	ValDisplay valdisp_DataAcq_P_2,userdata(tabcontrol)=  "ADC",fSize=14,fStyle=0
	...
	ValDisplay valdisp_DataAcq_P_3,pos={239,316},size={35,17},bodyWidth=35,disable=1
	ValDisplay valdisp_DataAcq_P_3,userdata(tabnum)=  "0"
	ValDisplay valdisp_DataAcq_P_3,userdata(tabcontrol)=  "ADC",fSize=14,fStyle=0
	...
	ValDisplay valdisp_DataAcq_P_4,pos={279,316},size={35,17},bodyWidth=35,disable=1
	ValDisplay valdisp_DataAcq_P_4,userdata(tabnum)=  "0"
	ValDisplay valdisp_DataAcq_P_4,userdata(tabcontrol)=  "ADC",fSize=14,fStyle=0
	...
	ValDisplay valdisp_DataAcq_P_5,pos={320,316},size={35,17},bodyWidth=35,disable=1
	ValDisplay valdisp_DataAcq_P_5,userdata(tabnum)=  "0"
	ValDisplay valdisp_DataAcq_P_5,userdata(tabcontrol)=  "ADC",fSize=14,fStyle=0
	...
	ValDisplay valdisp_DataAcq_P_6,pos={360,316},size={35,17},bodyWidth=35,disable=1
	ValDisplay valdisp_DataAcq_P_6,userdata(tabnum)=  "0"
	ValDisplay valdisp_DataAcq_P_6,userdata(tabcontrol)=  "ADC",fSize=14,fStyle=0
	...
	ValDisplay valdisp_DataAcq_P_7,pos={401,316},size={35,17},bodyWidth=35,disable=1
	ValDisplay valdisp_DataAcq_P_7,userdata(tabnum)=  "0"
	ValDisplay valdisp_DataAcq_P_7,userdata(tabcontrol)=  "ADC",fSize=14,fStyle=0
