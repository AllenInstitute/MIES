...
Window da_ephys() : Panel
	...
	SetVariable SetVar_Sweep,valueBackColor=(0,0,0),limits={0,1,1},value= _NUM:1
	...
	CheckBox Check_Settings_BackgrndDataAcq,pos={34,161},size={156,14},disable=3,title="Background Data Acquisition"
	...
	Button button_Settings_UpdateAmpStatus,pos={262,358},size={150,20},disable=1,proc=DAP_ButtonCtrlFindConnectedAmps,title="Query connected Amp(s)"
	...
	Slider slider_DataAcq_ActiveHeadstage,limits={0,7,1},value= 1,side= 2,vert= 0,ticks= 0,thumbColor= (43520,43520,43520)
	...
	TitleBox Title_DataAcq_Hold_VC,pos={1,209},size={50,20},userdata(tabnum)=  "0"
	...
	CheckBox check_DataAcq_Amp_Chain,pos={324,222},size={45,14},proc=DAP_CheckProc_AmpCntrls,title="Chain"
	...
	CheckBox check_DatAcq_ClearEnable,pos={372,311},size={51,14},proc=CheckProc_ClearEnable,title="Enable"
	...
	CheckBox check_DatAcq_SealALl,pos={164,311},size={29,14},title="All"
	...
	CheckBox check_DatAcq_BreakInAll,pos={273,311},size={29,14},title="All"
	...
	CheckBox check_DatAcq_ApproachAll,pos={55,311},size={29,14},title="All"
	...
	SetVariable setvar_Settings_InBathP,pos={162,619},size={105,16},disable=1,proc=DAP_SetVarProc_CAA,title="In bath P (psi)"
	...
	SetVariable setvar_Settings_InSliceP,pos={287,617},size={105,16},disable=1,proc=DAP_SetVarProc_CAA,title="In slice P (psi)"
	...
	SetVariable setvar_Settings_NearCellP,pos={40,638},size={111,16},disable=1,proc=DAP_SetVarProc_CAA,title="Near cell P (psi)"
	...
	SetVariable setvar_Settings_SealStartP,pos={157,638},size={110,16},disable=1,proc=DAP_SetVarProc_CAA,title="Seal Init P (psi)"
	...
	SetVariable setvar_Settings_SealMaxP,pos={277,637},size={115,16},disable=1,proc=DAP_SetVarProc_CAA,title="Seal max P (psi)"
	...
	SetVariable setvar_Settings_SurfaceHeight,pos={36,659},size={165,16},disable=1,proc=DAP_SetVarProc_CAA,title="Sol surface height\\Z11 (\\F'Symbol'm\\F'MS Sans Serif'm)"
	...
	SetVariable setvar_Settings_SliceSurfHeight,pos={226,659},size={166,16},disable=1,proc=DAP_SetVarProc_CAA,title="Slice surface height\\Z11 (\\F'Symbol'm\\F'MS Sans Serif'm)"
	...
	ModifyGraph width=25,wbRGB=(60928,60928,60928),gbRGB=(60928,60928,60928)
