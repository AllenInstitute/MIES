...
Window DataBrowser() : Graph
	...
	GroupBox group_properties_sweepFormula,pos={5.00,85.00},size={388.00,499.00},disable=3
	...
	SetVariable setvar_sweepFormula_parseResult,pos={28.00,535.00},size={359.00,18.00},disable=3
