...
Window DataBrowser() : Graph
	...
	SetWindow kwTopWin, userdata(SweepFormulaContentCRC)="724368977"
	...
	SetActiveSubwindow ##
	NewPanel/HOST=#/EXT=1/W=(445, 0, 0, 520) as " "
	...
	GroupBox group_properties_sweepFormula, pos={5.00, 85.00}, size={434.00, 434.00}, disable=3
	...
	GroupBox group_properties_sweepFormula, userdata(ResizeControlsInfo)=A"!!,?X!!#?c!!#C>!!#C>z!!#](Aon#azzzzzzzzzzzzzz!!#o2B4uAeBk2=!z"
	...
	ListBox list_of_ranges, pos={81.00, 198.00}, size={269.00, 315.00}, disable=3, proc=OVS_MainListBoxProc
	...
	GroupBox group_properties_sweeps, pos={5.00, 85.00}, size={434.00, 434.00}, disable=3
	GroupBox group_properties_sweeps, userdata(tabnum)="1"
	GroupBox group_properties_sweeps, userdata(tabcontrol)="Settings"
	GroupBox group_properties_sweeps, userdata(ResizeControlsInfo)=A"!!,?X!!#?c!!#C>!!#C>z!!#](Aon\"Qzzzzzzzzzzzzzz!!#o2B4uAezz"
	...
	GroupBox group_properties_artefact, pos={5.00, 85.00}, size={434.00, 434.00}, disable=3
	GroupBox group_properties_artefact, userdata(tabnum)="3"
	GroupBox group_properties_artefact, userdata(tabcontrol)="Settings"
	GroupBox group_properties_artefact, userdata(ResizeControlsInfo)=A"!!,?X!!#?c!!#C>!!#C>z!!#](Aon\"Qzzzzzzzzzzzzzz!!#o2B4uAezz"
	...
	ListBox list_of_ranges1, pos={75.00, 156.00}, size={281.00, 356.00}, disable=3, proc=AR_MainListBoxProc
	...
	ListBox list_of_ranges1, userdata(ResizeControlsInfo)=A"!!,EP!!#A+!!#BFJ,hsBz!!#](Aon\"Qzzzzzzzzzzzzzz!!#o2B4uAezz"
	...
	Button button_sweepFormula_display, pos={9.00, 488.00}, size={51.00, 22.00}, disable=3, proc=SF_button_sweepFormula_display
	...
	Button button_sweepFormula_display, userdata(ResizeControlsInfo)=A"!!,@s!!#CY!!#>Z!!#<hz!!#](Aon#azzzzzzzzzzzzzz!!#](Aon#SBk2=!z"
	...
	Button button_sweepFormula_check, pos={65.00, 488.00}, size={46.00, 22.00}, disable=3, proc=SF_button_sweepFormula_check
	...
	Button button_sweepFormula_check, userdata(ResizeControlsInfo)=A"!!,E<!!#CY!!#>F!!#<hz!!#](Aon#azzzzzzzzzzzzzz!!#](Aon#SBk2=!z"
	...
	TabControl SF_InfoTab, pos={8.00, 90.00}, size={424.00, 400.00}, disable=1, proc=ACL_DisplayTab
	...
	ListBox list_dashboard, pos={5.00, 90.00}, size={434.00, 424.00}, disable=1, proc=AD_ListBoxProc
	...
	ListBox list_dashboard, userdata(ResizeControlsInfo)=A"!!,?X!!#?m!!#C>!!#C9z!!#](Aon\"Qzzzzzzzzzzzzzz!!#o2B4uAezz"
	...
	Button button_sweepFormula_tofront, pos={115.00, 488.00}, size={51.00, 22.00}, disable=3, proc=SF_button_sweepFormula_tofront
	...
	Button button_sweepFormula_tofront, userdata(ResizeControlsInfo)=A"!!,FK!!#CY!!#>Z!!#<hz!!#](Aon#azzzzzzzzzzzzzz!!#](Aon#SBk2=!z"
	...
	Button button_sweepformula_all_code, pos={237.00, 488.00}, size={195.00, 19.00}, bodyWidth=80, disable=3, proc=PEXT_ButtonProc
	...
	Button button_sweepformula_all_code, userdata(ResizeControlsInfo)=A"!!,H(!!#CY!!#AR!!#<Pz!!#o2B4uAezzzzzzzzzzzzzz!!#o2B4uAeBk2=!z"
	...
	SetWindow kwTopWin, hook(ResizeControls)=ResizeControlsSafe
	SetWindow kwTopWin, userdata(ResizeControlsInfo)=A"!!*'\"z!!#CCJ,ht=zzzzzzzzzzzzzzzzzzzzz"
	SetWindow kwTopWin, userdata(ResizeControlsInfo)+=A"zzzzzzzzzzzzzzzzzzzzzzzzz"
	SetWindow kwTopWin, userdata(ResizeControlsInfo)+=A"zzzzzzzzzzzzzzzzzzz!!!"
	...
	SetWindow kwTopWin, userdata(ResizeControlsInfoUGVB)="NAME:UGVB;WIN:DataBrowser#BrowserSettingsPanel;TYPE:User;HORIZONTAL:1;POSITION:485.00;GUIDE1:FB;GUIDE2:;RELPOSITION:-35;"
	...
	SetWindow kwTopWin, userdata(ResizeControlsInfoMainBoxBottom)="NAME:MainBoxBottom;WIN:DataBrowser#BrowserSettingsPanel;TYPE:User;HORIZONTAL:1;POSITION:520.00;GUIDE1:FB;GUIDE2:;RELPOSITION:3;"
	...
	SetWindow kwTopWin, userdata(ResizeControlsInfoUGVM)="NAME:UGVM;WIN:DataBrowser#BrowserSettingsPanel;TYPE:User;HORIZONTAL:1;POSITION:400.00;GUIDE1:FB;GUIDE2:;RELPOSITION:-120;"
	...
	Notebook kwTopWin, zdata="GaqDU%ejN7!Z)u.`Q5gp6juaS/:,3X3s1Uq&W)/A<ZkuTiY!A_!5p$Gkpdg(%S7O!>8lc2\"sb*'&->1kks^GSl)>#u$IK&=$CQ0RZ+LJRs+(0Gq>Yr#8mAOBim\\s@1*E!R>bV7p^`#(0+9lNE!(E&,'(bZlF,Dgp>r6[h.Z;JK;[\\I?1c9Or0MN8bS!oLB!]1W_->KIZF^S4k#ZcdVL'9-'!n<5Za2$W\"?^.%IK0'3$3^C&'JWR_Ogb9E,Z,naUj=j88E%K-7>4,=XS=,P=i1-E@S=c\"f:^$j#.U-f"
	...
	Notebook kwTopWin, defaultTab=10, autoSave=1, magnification=100, showRuler=0, rulerUnits=2
	Notebook kwTopWin, newRuler=Normal, justification=0, margins={0, 0, 285}, spacing={0, 0, 0}, tabs={}, rulerDefaults={"Arial", 11, 0, (0, 0, 0)}
	Notebook kwTopWin, zdata="GaqDU%ejN7!Z)u^\"(F_BAcgu5]go4[&.'2989@[[K>tpnK\"?L6M8jCF%YJ7gAmu5P!+*eTP5"
	Notebook kwTopWin, zdataEnd=1
	SetWindow kwTopWin, userdata(tabcontrol)="SF_InfoTab"
	SetWindow kwTopWin, userdata(tabnum)="0"
