...
Window DataBrowser() : Graph
	...
	Display /W=(910.5,131.75,1342.5,566.75)/K=1  as "DataBrowser"
	...
	GroupBox group_SB_axes_scaling,pos={28.00,245.00},size={285.00,51.00},title="Axes Scaling"
	...
	SetVariable setvar_pulseAver_overridePulseLength,pos={214.00,296.00},size={136.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Override length"
	...
	SetVariable setvar_pulseAver_endPulse,pos={218.00,254.00},size={122.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Ending pulse"
	...
	SetVariable setvar_pulseAver_startPulse,pos={214.00,232.00},size={126.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Starting pulse"
	...
	CheckBox check_pulseAver_multGraphs,pos={212.00,165.00},size={121.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Use multiple graphs"
	...
	CheckBox check_pulseAver_zero,pos={212.00,108.00},size={76.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Zero pulses"
	...
	CheckBox check_pulseAver_showAver,pos={212.00,146.00},size={89.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Show average"
	...
	CheckBox check_pulseAver_indPulses,pos={212.00,183.00},size={136.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Show individual pulses"
	...
	CheckBox check_pulseAver_deconv,pos={71.00,340.00},size={94.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Deconvolution"
	...
	CheckBox check_pulseAver_timeAlign,pos={212.00,127.00},size={99.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Time alignment"
	...
	SetVariable setvar_pulseAver_deconv_tau,pos={79.00,359.00},size={98.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Tau [ms]"
	...
	SetVariable setvar_pulseAver_deconv_smth,pos={65.00,383.00},size={112.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Smoothing"
	...
	SetVariable setvar_pulseAver_deconv_range,pos={59.00,404.00},size={118.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Display [ms]"
	...
	CheckBox check_BrowserSettings_DAC,pos={36.00,36.00},size={32.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="DA"
	...
	CheckBox check_BrowserSettings_OChan,pos={202.00,36.00},size={106.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="Overlay channels"
	...
	CheckBox check_BrowserSettings_dDAQ,pos={330.00,35.00},size={48.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="dDAQ"
	...
	CheckBox check_Calculation_ZeroTraces,pos={143.00,200.00},size={75.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="Zero Traces"
	...
	CheckBox check_Calculation_AverageTraces,pos={40.00,199.00},size={94.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="Average Traces"
	...
	Button button_Calculation_RestoreData,pos={231.00,208.00},size={75.00,24.00},proc=BSP_ButtonProc_RestoreData,title="Restore"
	...
	Button button_BrowserSettings_Export,pos={90.00,327.00},size={99.00,24.00},proc=SB_ButtonProc_ExportTraces,title="Export Traces"
	...
	CheckBox check_SweepControl_HideSweep,pos={39.00,219.00},size={112.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="Hide sweep Traces"
	...
	CheckBox check_BrowserSettings_splitTTL,pos={148.00,56.00},size={58.00,15.00},disable=2,proc=BSP_CheckProc_ChangedSetting,title="sep. TTL"
	...
	PopupMenu popup_DB_lockedDevices,pos={32.00,301.00},size={205.00,19.00},bodyWidth=100,proc=DB_PopMenuProc_LockDBtoDevice,title="Device assignment:"
	...
	SetVariable setvar_sweepFormula_parseResult,pos={28.00,535.00},size={359.00,18.00},disable=1
	...
	SetVariable setvar_sweepFormula_parseResult,userdata(ResizeControlsInfo)= A"!!,CD!!#Cj^]6a.J,hlsz!!#](Aon#azzzzzzzzzzzzzz!!#o2B4uAeBk2=!z"
	...
	Button button_sweepFormula_display,pos={9.00,553.00},size={51.00,22.00},disable=1,proc=SF_button_sweepFormula_display,title="Display"
	...
	Button button_sweepFormula_check,pos={65.00,553.00},size={46.00,22.00},disable=1,proc=SF_button_sweepFormula_check,title="Check"
	...
	CheckBox check_BrowserSettings_DS,pos={164.00,47.00},size={51.00,15.00},disable=1,proc=AD_CheckProc_Toggle,title="enable"
	...
	CheckBox check_BrowserSettings_DB_Passed,pos={15.00,35.00},size={52.00,15.00},disable=3,proc=AD_CheckProc_PassedSweeps,title="Passed"
	...
	CheckBox check_BrowserSettings_DB_Failed,pos={15.00,56.00},size={47.00,15.00},disable=3,proc=AD_CheckProc_FailedSweeps,title="Failed"
	...
	CheckBox check_pulseAver_searchFailedPulses,pos={214.00,340.00},size={119.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Search failed pulses"
	...
	CheckBox check_pulseAver_hideFailedPulses,pos={214.00,361.00},size={109.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Hide failed pulses"
	...
	SetVariable setvar_pulseAver_failedPulses_level,pos={214.00,383.00},size={81.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Level"
	...
	SetVariable setvar_pulseAver_vert_scale_bar,pos={45.00,129.00},size={142.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Vertical scale bar"
	...
	CheckBox check_pulseAver_ShowImage,pos={52.00,225.00},size={111.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Enable image plot"
	...
	GroupBox group_pulseAver_general,pos={199.00,89.00},size={175.00,350.00},disable=3,title="General"
	...
	GroupBox group_pulseAver_trace_settings,pos={39.00,90.00},size={155.00,96.00},disable=3,title="Trace settings"
	...
	GroupBox group_pulseAver_image_settings,pos={39.00,186.00},size={154.00,131.00},disable=3,title="Image settings"
	...
	CheckBox check_pulseAver_showTraces,pos={48.00,109.00},size={104.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Enable trace plot"
	...
	CheckBox check_pulseAver_drawXZeroLine,pos={213.00,202.00},size={100.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Draw X zero line"
	...
	CheckBox check_pulseAver_fixedPulseLength,pos={217.00,277.00},size={112.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Fixed pulse length"
	...
	PopupMenu popup_pulseAver_pulseSortOrder,pos={48.00,266.00},size={137.00,19.00},bodyWidth=82,disable=1,proc=PA_PopMenuProc_Common,title="Sort order"
	...
	GroupBox group_pulseAver_failedPulses,pos={206.00,324.00},size={157.00,111.00},disable=3,title="Failed Pulses"
	...
	GroupBox group_pulseAver_singlePulse,pos={205.00,216.00},size={158.00,107.00},disable=3,title=" Pulses"
	...
	SetVariable setvar_pulseAver_numberOfSpikes,pos={211.00,407.00},size={148.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Number of Spikes"
	...
	CheckBox check_BrowserSettings_VisEpochs,pos={37.00,56.00},size={102.00,15.00},disable=2,proc=BSP_CheckProc_ChangedSetting,title="Visualize Epochs"
	...
	Button button_sweepFormula_tofront,pos={115.00,553.00},size={51.00,22.00},disable=1,proc=SF_button_sweepFormula_tofront,title="To Front"
	...
	ModifyPanel fixedSize=0
	Button popupext_TPStorageKeys,pos={413.00,67.00},size={150.00,19.00},bodyWidth=150,proc=PEXT_ButtonProc,title="Testpulse Storage Entries ▼"
	...
	Button button_clearlabnotebookgraph,pos={401.00,122.00},size={80.00,25.00},proc=LBV_ButtonProc_ClearGraph,title="Clear graph"
	...
	Button button_switchxaxis,pos={493.00,122.00},size={80.00,25.00},proc=LBV_ButtonProc_SwitchXAxis,title="Switch X-axis"
	...
	Button button_DataBrowser_setaxis,pos={400.00,151.00},size={171.00,25.00},proc=LBV_ButtonProc_AutoScale,title="Autoscale"
	...
	PopupMenu popup_experiment,pos={405.00,11.00},size={164.00,19.00},bodyWidth=95,title="Experiment: "
	...
	PopupMenu popup_Device,pos={430.00,34.00},size={139.00,19.00},bodyWidth=95,title="Device: "
	...
	Button popupext_LBKeys,pos={413.00,92.00},size={150.00,19.00},bodyWidth=150,proc=PEXT_ButtonProc,title="Lab Notebook Entries ▼"
