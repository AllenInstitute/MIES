...
Window DataBrowser() : Graph
	...
	SetVariable setvar_SweepControl_SweepNo,limits={0,0,1},value= _NUM:NaN,live= 1
	...
	CheckBox check_pulseAver_timeAlign,pos={124.00,348.00},size={102.00,15.00},disable=3,proc=PA_CheckProc_Common,title="Time Alignment"
	...
	TabControl SF_InfoTab,tabLabel(2)="Help",value= 0,userdata(Config_DontRestore)=  "1",userdata(Config_DontSave)=  "1"
