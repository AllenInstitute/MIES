...
Window DataBrowser() : Graph
	...
	SetWindow kwTopWin,userdata(ResizeControlsInfo)= A"!!*'\"z!!#C=!!#C>J,fQLzzzzzzzzzzzzzzzzzzzz"
	...
	Execute/Q/Z "SetWindow kwTopWin sizeLimit={324,326.25,inf,inf}" // sizeLimit requires Igor 7 or later
	NewPanel/HOST=#/EXT=2/W=(0,0,580,66)  as "Sweep Control"
	Button button_SweepControl_NextSweep,pos={333.00,0.00},size={150.00,36.00},proc=BSP_ButtonProc_ChangeSweep
	...
	ValDisplay valdisp_SweepControl_LastSweep,pos={231.00,3.00},size={89.00,34.00},bodyWidth=60
	...
	SetVariable setvar_SweepControl_SweepStep,pos={479.00,0.00},size={91.00,35.00},bodyWidth=40
	...
	Button button_SweepControl_PrevSweep,pos={0.00,0.00},size={150.00,36.00},proc=BSP_ButtonProc_ChangeSweep
	...
	CheckBox check_SweepControl_AutoUpdate,pos={345.00,42.00},size={160.00,15.00}
	...
	GroupBox group_pulseAver_failedPulses,title="Failed Pulses"
