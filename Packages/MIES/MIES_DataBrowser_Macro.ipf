...
Window DataBrowser() : Graph
	...
	Display /W=(423,419.75,855,854.75)/K=1  as "DataBrowser"
	...
	SetWindow kwTopWin,userdata(ResizeControlsInfo)= A"!!*'\"z!!#C<5QF0M^]4?7zzzzzzzzzzzzzzzzzzzz"
	SetWindow kwTopWin,userdata(ResizeControlsInfo) += A"zzzzzzzzzzzzzzzzzzzzzzzzz"
	SetWindow kwTopWin,userdata(ResizeControlsInfo) += A"zzzzzzzzzzzzzzzzzzz!!!"
	Execute/Q/Z "SetWindow kwTopWin sizeLimit={321.75,252.75,inf,inf}" // sizeLimit requires Igor 7 or later
	NewPanel/HOST=#/EXT=2/W=(0,0,580,70)  as "Sweep Control"
	Button button_SweepControl_NextSweep,pos={331.00,4.00},size={150.00,36.00},proc=BSP_ButtonProc_ChangeSweep,title="Next  \\W649"
	...
	ValDisplay valdisp_SweepControl_LastSweep,pos={237.00,4.00},size={89.00,34.00},bodyWidth=60,title="of"
	...
	SetVariable setvar_SweepControl_SweepStep,pos={486.00,4.00},size={91.00,35.00},bodyWidth=40,title="Step"
	...
	SetVariable setvar_SweepControl_SweepStep,fSize=24
	SetVariable setvar_SweepControl_SweepStep,limits={1,inf,1},value= _NUM:1
	Button button_SweepControl_PrevSweep,pos={3.00,4.00},size={150.00,36.00},proc=BSP_ButtonProc_ChangeSweep,title="\\W646 Previous"
	...
	CheckBox check_SweepControl_AutoUpdate,pos={343.00,44.00},size={160.00,15.00},title="Display last sweep acquired"
	...
	GroupBox group_SB_axes_scaling,pos={50.00,245.00},size={285.00,51.00},title="Axes Scaling"
	...
	GroupBox group_calc,pos={50.00,195.00},size={288.00,51.00}
	...
	GroupBox group_timealignment,pos={50.00,87.00},size={285.00,99.00},title="Time Alignment"
	...
	PopupMenu popup_overlaySweeps_select,pos={145.00,99.00},size={143.00,19.00},bodyWidth=109,disable=3,proc=OVS_PopMenuProc_Select,title="Select"
	...
	CheckBox check_overlaySweeps_disableHS,pos={94.00,159.00},size={121.00,15.00},disable=3,proc=OVS_CheckBoxProc_HS_Select,title="Headstage Removal"
	...
	CheckBox check_overlaySweeps_non_commula,pos={94.00,180.00},size={154.00,15.00},disable=3,title="Non-commulative update"
	...
	SetVariable setvar_overlaySweeps_offset,pos={132.00,126.00},size={81.00,18.00},bodyWidth=45,disable=3,proc=OVS_SetVarProc_SelectionRange,title="Offset"
	...
	SetVariable setvar_overlaySweeps_step,pos={219.00,126.00},size={72.00,18.00},bodyWidth=45,disable=3,proc=OVS_SetVarProc_SelectionRange,title="Step"
	...
	GroupBox group_enable_sweeps,pos={5.00,25.00},size={434.00,50.00},disable=1,title="Overlay Sweeps"
	...
	GroupBox group_enable_channels,pos={31.00,25.00},size={380.00,380.00},disable=1,title="Channel Selection"
	...
	GroupBox group_enable_artifact,pos={5.00,25.00},size={434.00,50.00},disable=1,title="Artefact Removal"
	...
	GroupBox group_channelSel_DA,pos={135.00,41.00},size={44.00,206.00},disable=1,title="DA"
	...
	GroupBox group_enable_pulse,pos={31.00,25.00},size={380.00,50.00},disable=1,title="Pulse Averaging"
	...
	CheckBox check_channelSel_DA_0,pos={143.00,60.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="0"
	...
	CheckBox check_channelSel_DA_1,pos={143.00,81.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="1"
	...
	CheckBox check_channelSel_DA_2,pos={143.00,102.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="2"
	...
	CheckBox check_channelSel_DA_3,pos={143.00,123.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="3"
	...
	CheckBox check_channelSel_DA_4,pos={143.00,144.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="4"
	...
	CheckBox check_channelSel_DA_5,pos={143.00,165.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="5"
	...
	CheckBox check_channelSel_DA_6,pos={143.00,186.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="6"
	...
	CheckBox check_channelSel_DA_7,pos={143.00,207.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="7"
	...
	GroupBox group_channelSel_HEADSTAGE,pos={71.00,42.00},size={46.00,206.00},disable=1,title="HS"
	...
	CheckBox check_channelSel_HEADSTAGE_0,pos={80.00,60.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="0"
	...
	CheckBox check_channelSel_HEADSTAGE_1,pos={80.00,81.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="1"
	...
	CheckBox check_channelSel_HEADSTAGE_2,pos={80.00,102.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="2"
	...
	CheckBox check_channelSel_HEADSTAGE_3,pos={80.00,123.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="3"
	...
	CheckBox check_channelSel_HEADSTAGE_4,pos={80.00,144.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="4"
	...
	CheckBox check_channelSel_HEADSTAGE_5,pos={80.00,165.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="5"
	...
	CheckBox check_channelSel_HEADSTAGE_6,pos={80.00,186.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="6"
	...
	CheckBox check_channelSel_HEADSTAGE_7,pos={80.00,207.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="7"
	...
	GroupBox group_channelSel_AD,pos={193.00,42.00},size={65.00,204.00},disable=1,title="AD"
	...
	CheckBox check_channelSel_AD_0,pos={200.00,60.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="0"
	...
	CheckBox check_channelSel_AD_1,pos={200.00,81.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="1"
	...
	CheckBox check_channelSel_AD_2,pos={200.00,102.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="2"
	...
	CheckBox check_channelSel_AD_3,pos={200.00,123.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="3"
	...
	CheckBox check_channelSel_AD_4,pos={200.00,144.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="4"
	...
	CheckBox check_channelSel_AD_5,pos={200.00,165.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="5"
	...
	CheckBox check_channelSel_AD_6,pos={200.00,186.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="6"
	...
	CheckBox check_channelSel_AD_7,pos={200.00,207.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="7"
	...
	CheckBox check_channelSel_AD_8,pos={225.00,60.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="8"
	...
	CheckBox check_channelSel_AD_9,pos={225.00,81.00},size={22.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="9"
	...
	CheckBox check_channelSel_AD_10,pos={225.00,102.00},size={28.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="10"
	...
	CheckBox check_channelSel_AD_11,pos={225.00,123.00},size={28.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="11"
	...
	CheckBox check_channelSel_AD_12,pos={225.00,144.00},size={28.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="12"
	...
	CheckBox check_channelSel_AD_13,pos={225.00,165.00},size={28.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="13"
	...
	CheckBox check_channelSel_AD_14,pos={225.00,186.00},size={28.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="14"
	...
	CheckBox check_channelSel_AD_15,pos={225.00,207.00},size={28.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="15"
	...
	Button button_RemoveRanges,pos={113.00,126.00},size={54.00,21.00},disable=3,proc=AR_ButtonProc_RemoveRanges,title="Remove"
	...
	SetVariable setvar_cutoff_length_before,pos={116.00,96.00},size={150.00,18.00},disable=3,proc=AR_SetVarProcCutoffLength,title="Cutoff length [ms]:"
	...
	CheckBox check_auto_remove,pos={182.00,129.00},size={85.00,15.00},disable=3,proc=AR_CheckProc_Update,title="Auto remove"
	...
	CheckBox check_highlightRanges,pos={284.00,129.00},size={31.00,15.00},disable=3,proc=AR_CheckProc_Update,title="HL"
	...
	SetVariable setvar_pulseAver_overridePulseLength,pos={236.00,296.00},size={136.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Override length"
	...
	SetVariable setvar_pulseAver_endPulse,pos={240.00,254.00},size={122.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Ending pulse"
	...
	SetVariable setvar_pulseAver_startPulse,pos={236.00,232.00},size={126.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Starting pulse"
	...
	CheckBox check_pulseAver_multGraphs,pos={234.00,165.00},size={121.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Use multiple graphs"
	...
	CheckBox check_pulseAver_zero,pos={234.00,108.00},size={76.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Zero pulses"
	...
	CheckBox check_pulseAver_showAver,pos={234.00,146.00},size={89.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Show average"
	...
	CheckBox check_pulseAver_indPulses,pos={234.00,183.00},size={136.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Show individual pulses"
	...
	CheckBox check_pulseAver_deconv,pos={93.00,340.00},size={94.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Deconvolution"
	...
	CheckBox check_pulseAver_timeAlign,pos={234.00,127.00},size={99.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Time alignment"
	...
	SetVariable setvar_pulseAver_deconv_tau,pos={101.00,359.00},size={98.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Tau [ms]"
	...
	SetVariable setvar_pulseAver_deconv_smth,pos={87.00,383.00},size={112.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Smoothing"
	...
	SetVariable setvar_pulseAver_deconv_range,pos={81.00,404.00},size={118.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Display [ms]"
	...
	CheckBox check_BrowserSettings_OVS,pos={186.00,47.00},size={51.00,15.00},disable=1,proc=BSP_CheckProc_OverlaySweeps,title="enable"
	...
	CheckBox check_BrowserSettings_AR,pos={186.00,47.00},size={51.00,15.00},disable=1,proc=BSP_CheckBoxProc_ArtRemoval,title="enable"
	...
	CheckBox check_BrowserSettings_PA,pos={186.00,47.00},size={51.00,15.00},disable=1,proc=BSP_CheckBoxProc_PerPulseAver,title="enable"
	...
	CheckBox check_BrowserSettings_DAC,pos={58.00,36.00},size={32.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="DA"
	...
	CheckBox check_BrowserSettings_DAC,userdata(Config_RestorePriority)=  "10"
	CheckBox check_BrowserSettings_DAC,value= 0
	CheckBox check_BrowserSettings_ADC,pos={113.00,36.00},size={32.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="AD"
	...
	CheckBox check_BrowserSettings_ADC,userdata(Config_RestorePriority)=  "10"
	CheckBox check_BrowserSettings_ADC,value= 1
	CheckBox check_BrowserSettings_TTL,pos={170.00,36.00},size={34.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="TTL"
	...
	CheckBox check_BrowserSettings_TTL,userdata(Config_RestorePriority)=  "10"
	CheckBox check_BrowserSettings_TTL,value= 0
	CheckBox check_BrowserSettings_OChan,pos={224.00,36.00},size={106.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="Overlay channels"
	...
	CheckBox check_BrowserSettings_dDAQ,pos={352.00,35.00},size={48.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="dDAQ"
	...
	CheckBox check_Calculation_ZeroTraces,pos={165.00,200.00},size={75.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="Zero Traces"
	...
	CheckBox check_Calculation_AverageTraces,pos={62.00,199.00},size={94.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="Average Traces"
	...
	CheckBox check_BrowserSettings_TA,pos={176.00,111.00},size={51.00,15.00},proc=BSP_TimeAlignmentProc,title="enable"
	...
	CheckBox check_BrowserSettings_TA,userdata(Config_RestorePriority)=  "10"
	CheckBox check_BrowserSettings_TA,value= 0
	CheckBox check_ovs_clear_on_new_ra_cycle,pos={257.00,161.00},size={111.00,15.00},disable=3,title="Clear on new RAC"
	...
	CheckBox check_ovs_clear_on_new_stimset_cycle,pos={257.00,181.00},size={105.00,15.00},disable=3,title="Clear on new SCI"
	...
	PopupMenu popup_TimeAlignment_Mode,pos={53.00,135.00},size={143.00,19.00},bodyWidth=50,disable=2,proc=BSP_TimeAlignmentPopup,title="Alignment Mode"
	...
	SetVariable setvar_TimeAlignment_LevelCross,pos={209.00,135.00},size={48.00,18.00},disable=2,proc=BSP_TimeAlignmentLevel,title="Level"
	...
	Button button_TimeAlignment_Action,pos={230.00,159.00},size={30.00,18.00},disable=2,proc=BSP_DoTimeAlignment,title="Do!"
	...
	CheckBox check_Display_VisibleXrange,pos={62.00,270.00},size={41.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="Vis X"
	...
	CheckBox check_Display_EqualYrange,pos={116.00,270.00},size={55.00,15.00},proc=BSP_CheckProc_ScaleAxes,title="Equal Y"
	...
	CheckBox check_Display_EqualYignore,pos={176.00,270.00},size={84.00,15.00},proc=BSP_CheckProc_ScaleAxes,title="Ignore traces"
	...
	PopupMenu popup_TimeAlignment_Master,pos={66.00,159.00},size={134.00,19.00},bodyWidth=50,disable=2,proc=BSP_TimeAlignmentPopup,title="Reference trace"
	...
	Button button_Calculation_RestoreData,pos={253.00,208.00},size={75.00,24.00},proc=BSP_ButtonProc_RestoreData,title="Restore"
	...
	Button button_BrowserSettings_Export,pos={112.00,327.00},size={99.00,24.00},proc=SB_ButtonProc_ExportTraces,title="Export Traces"
	...
	CheckBox check_SweepControl_HideSweep,pos={61.00,219.00},size={112.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="Hide sweep Traces"
	...
	CheckBox check_BrowserSettings_splitTTL,pos={170.00,56.00},size={58.00,15.00},disable=2,proc=BSP_CheckProc_ChangedSetting,title="sep. TTL"
	...
	PopupMenu popup_DB_lockedDevices,pos={54.00,301.00},size={205.00,19.00},bodyWidth=100,proc=DB_PopMenuProc_LockDBtoDevice,title="Device assignment:"
	...
	GroupBox group_enable_sweepFormula,pos={5.00,25.00},size={434.00,50.00},disable=1,title="SweepFormula"
	...
	Button button_sweepFormula_display,pos={9.00,421.00},size={51.00,22.00},disable=3,proc=SF_button_sweepFormula_display,title="Display"
	...
	Button button_sweepFormula_check,pos={65.00,421.00},size={46.00,22.00},disable=3,proc=SF_button_sweepFormula_check,title="Check"
	...
	CheckBox check_BrowserSettings_DS,pos={186.00,47.00},size={51.00,15.00},disable=1,proc=AD_CheckProc_Toggle,title="enable"
	...
	CheckBox check_BrowserSettings_DB_Passed,pos={37.00,35.00},size={52.00,15.00},disable=3,proc=AD_CheckProc_PassedSweeps,title="Passed"
	...
	CheckBox check_BrowserSettings_DB_Failed,pos={37.00,56.00},size={47.00,15.00},disable=3,proc=AD_CheckProc_FailedSweeps,title="Failed"
	...
	CheckBox check_BrowserSettings_SF,pos={186.00,47.00},size={51.00,15.00},disable=1,proc=BSP_CheckBoxProc_SweepFormula,title="enable"
	...
	CheckBox check_channelSel_HEADSTAGE_ALL,pos={79.00,225.00},size={30.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="All"
	...
	CheckBox check_channelSel_DA_All,pos={143.00,225.00},size={30.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="All"
	...
	CheckBox check_channelSel_AD_All,pos={210.00,225.00},size={30.00,15.00},disable=1,proc=BSP_CheckProc_ChangedSetting,title="All"
	...
	CheckBox check_pulseAver_searchFailedPulses,pos={236.00,340.00},size={119.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Search failed pulses"
	...
	CheckBox check_pulseAver_hideFailedPulses,pos={236.00,361.00},size={109.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Hide failed pulses"
	...
	SetVariable setvar_pulseAver_failedPulses_level,pos={236.00,383.00},size={81.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Level"
	...
	SetVariable setvar_pulseAver_vert_scale_bar,pos={67.00,129.00},size={142.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Vertical scale bar"
	...
	CheckBox check_pulseAver_ShowImage,pos={74.00,225.00},size={111.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Enable image plot"
	...
	GroupBox group_pulseAver_general,pos={221.00,89.00},size={175.00,350.00},disable=3,title="General"
	GroupBox group_pulseAver_general,userdata(tabnum)=  "4"
	...
	GroupBox group_pulseAver_trace_settings,pos={61.00,90.00},size={155.00,96.00},disable=3,title="Trace settings"
	...
	GroupBox group_pulseAver_image_settings,pos={61.00,186.00},size={154.00,131.00},disable=3,title="Image settings"
	...
	CheckBox check_pulseAver_showTraces,pos={70.00,109.00},size={104.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Enable trace plot"
	...
	CheckBox check_pulseAver_drawXZeroLine,pos={235.00,202.00},size={100.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Draw X zero line"
	...
	CheckBox check_pulseAver_fixedPulseLength,pos={239.00,277.00},size={112.00,15.00},disable=1,proc=PA_CheckProc_Common,title="Fixed pulse length"
	...
	PopupMenu popup_pulseAver_pulseSortOrder,pos={70.00,266.00},size={137.00,19.00},bodyWidth=82,disable=1,proc=PA_PopMenuProc_Common,title="Sort order"
	...
	GroupBox group_pulseAver_failedPulses,pos={228.00,324.00},size={157.00,111.00},disable=3,title="Failed Pulses"
	GroupBox group_pulseAver_failedPulses,userdata(tabnum)=  "4"
	...
	GroupBox group_pulseAver_singlePulse,pos={227.00,216.00},size={158.00,107.00},disable=3,title=" Pulses"
	GroupBox group_pulseAver_singlePulse,userdata(tabnum)=  "4"
	...
	SetVariable setvar_pulseAver_numberOfSpikes,pos={233.00,407.00},size={148.00,18.00},bodyWidth=50,disable=1,proc=PA_SetVarProc_Common,title="Number of Spikes"
	...
	CheckBox check_BrowserSettings_VisEpochs,pos={59.00,56.00},size={102.00,15.00},proc=BSP_CheckProc_ChangedSetting,title="Visualize Epochs"
	...
	Button button_sweepFormula_tofront,pos={115.00,421.00},size={51.00,22.00},disable=3,proc=SF_button_sweepFormula_tofront,title="To Front"
	...
	Button button_sweepformula_all_code,pos={237.00,421.00},size={195.00,19.00},bodyWidth=80,disable=3,proc=PEXT_ButtonProc,title="Formerly executed code ▼"
	...
	Notebook kwTopWin font="Lucida Console", fSize=11, fStyle=0, textRGB=(0,0,0)
	Notebook kwTopWin, zdata= "GaqDU%ejN7!Z)t;Aq0k.+MM:Wn-B,Y+=49<;1gg<[&>t!W*$r7a%93b[l?5m27Z+\"3?p730/Wt_lCt7V>b7Bf:op@iaf>^JRC<n4"
	...
	ModifyPanel fixedSize=0
	GroupBox group_graph_x_axis,pos={479.00,140.00},size={98.00,59.00}
	...
	Button button_clearlabnotebookgraph,pos={385.00,144.00},size={90.00,25.00},proc=LBV_ButtonProc_ClearGraph,title="Clear graph"
	...
	Button button_switchxaxis,pos={483.00,144.00},size={87.00,25.00},proc=LBV_ButtonProc_SwitchXAxis,title="Switch X-axis"
	...
	Button popupext_TPStorageKeys,pos={398.00,67.00},size={167.00,19.00},bodyWidth=150,proc=PEXT_ButtonProc,title="Testpulse Storage Entries ▼"
	...
	GroupBox group_labnotebook_experiment_device,pos={387.00,5.00},size={190.00,55.00}
	...
	PopupMenu popup_experiment,pos={407.00,11.00},size={164.00,19.00},bodyWidth=95,title="Experiment: "
	...
	PopupMenu popup_Device,pos={432.00,34.00},size={139.00,19.00},bodyWidth=95,title="Device: "
	...
	Button popupext_LBKeys,pos={398.00,91.00},size={167.00,19.00},bodyWidth=150,proc=PEXT_ButtonProc,title="Lab Notebook Entries ▼"
	...
	GroupBox group_labnotebook_experiment_device1,pos={386.00,61.00},size={191.00,78.00}
	...
	Button popupext_resultsKeys,pos={398.00,115.00},size={167.00,19.00},bodyWidth=150,proc=PEXT_ButtonProc,title="Results Entries ▼"
	...
	CheckBox check_limit_x_selected_sweeps,pos={486.00,174.00},size={60.00,15.00},title="Selected"
	...
	Execute/Q/Z "SetWindow kwTopWin sizeLimit={441,170.25,inf,inf}" // sizeLimit requires Igor 7 or later
	...
	Notebook kwTopWin, defaultTab=10, autoSave= 0, showRuler=0, rulerUnits=0
	Notebook kwTopWin newRuler=Normal, justification=0, margins={0,0,84}, spacing={0,0,0}, tabs={}, rulerDefaults={"Arial",11,0,(0,0,0)}
