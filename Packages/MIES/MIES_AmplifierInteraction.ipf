...
Function AI_ReadFromAmplifier(string device, variable headStage, variable mode, variable func, [variable checkBeforeWrite, variable usePrefixes, variable selectAmp])
	...
	if(ParamIsdefault(usePrefixes))
		return AI_SendToAmp(device, headStage, mode, func, MCC_READ, checkBeforeWrite = checkBeforeWrite, selectAmp = selectAmp)
	else
		return AI_SendToAmp(device, headStage, mode, func, MCC_READ, checkBeforeWrite = checkBeforeWrite, usePrefixes = usePrefixes, selectAmp = selectAmp)
	endif
End
