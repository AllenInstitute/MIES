...
Function/WAVE SFO_OperationPrepareFit(STRUCT SF_ExecutionData &exd)
	...
	confLevel = SFH_GetArgumentAsNumeric(exd, opShort, 4, defValue = 85, checkFunc = BetweenZeroAndOneHoundred)
...
static Function/WAVE SFO_OperationFit2Impl(WAVE wvY, WAVE/Z wvX, WAVE/WAVE prepFit)
	...
	strswitch(errorbarType)
		case SF_PREPAREFIT_ERRORBARTYPE_STANDARD:
			...
			reducedChiSquare = SFO_OperationFit2CalcReducedChiSquareStatistic(yResiduals, weightY, degFreedom)
		...
		case SF_PREPAREFIT_ERRORBARTYPE_CONFIDENCE:
			WAVE/Z lowerBar = lowerConf
			WAVE/Z upperBar = upperConf
			break
		case SF_PREPAREFIT_ERRORBARTYPE_PREDICTION:
			WAVE/Z lowerBar = lowerPred
			WAVE/Z upperBar = upperPred
			break
		default:
