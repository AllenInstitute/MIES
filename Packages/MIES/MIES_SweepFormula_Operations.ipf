...
static Function/WAVE SFO_OperationFit2Impl(WAVE wvY, WAVE/Z wvX, WAVE/WAVE prepFit)
	...
	strswitch(errorbarType)
		case SF_PREPAREFIT_ERRORBARTYPE_STANDARD:
			...
			if(xErrorsOut)
				...
				WAVE errorbarXPlus  = xErrors
				WAVE errorbarXMinus = xErrors
			endif
			break
	...
	if(xErrorsOut)
		JWN_SetWaveInWaveNote(fitOutput, SF_META_ERRORBARXMINUS, errorbarXMinus)
		JWN_SetWaveInWaveNote(fitOutput, SF_META_ERRORBARXPLUS, errorbarXPlus)
	endif
