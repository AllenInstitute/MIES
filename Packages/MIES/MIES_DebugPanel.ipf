...
static Function DebuggingEnabledForFile(file)
	string file
...
Window DebugPanel() : Panel
	...
	CheckBox check_itc_xop_debug_mode,pos={254.00,11.00},size={121.00,15.00},proc=CheckProc_Debug,title="ITC XOP Debugging"
	...
	CheckBox check_debug_mode,pos={20.00,11.00},size={74.00,15.00},proc=CheckProc_Debug,title="Debugging"
	...
	PopupMenu popup_select_files,pos={106.00,9.00},size={90.00,19.00},proc=PopMenuProc_Selection,title="Selection:"
...
Function CheckProc_Debug(cba) : CheckBoxControl
...
Function PopMenuProc_Selection(pa) : PopupMenuControl
