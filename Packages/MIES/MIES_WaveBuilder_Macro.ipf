...
Window WaveBuilder() : Panel
	...
	SetVariable SetVar_WB_NumEpochs_S100, pos={30.00, 66.00}, size={124.00, 22.00}, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_NumEpochs_S100, title="Total Epochs"
	...
	SetVariable SetVar_WaveBuilder_P0, pos={365.00, 52.00}, size={100.00, 18.00}, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P0, title="Duration"
	...
	SetVariable SetVar_WaveBuilder_P1, pos={471.00, 52.00}, size={100.00, 18.00}, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P1, title="Delta"
	...
	SetVariable SetVar_WB_SweepCount_S101, pos={27.00, 90.00}, size={127.00, 22.00}, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_SweepCount_S101, title="Total Sweeps"
	...
	SetVariable setvar_WaveBuilder_P10, pos={364.00, 124.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable setvar_WaveBuilder_P10, title="Tau Rise"
	...
	SetVariable setvar_WaveBuilder_P12, pos={364.00, 146.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable setvar_WaveBuilder_P12, title="Tau Decay 1"
	...
	SetVariable setvar_WaveBuilder_P14, pos={364.00, 170.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable setvar_WaveBuilder_P14, title="Tau Decay 2"
	...
	SetVariable setvar_WaveBuilder_P16, pos={364.00, 193.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable setvar_WaveBuilder_P16, title="Tau 2 weight"
	...
	SetVariable setvar_WaveBuilder_P17, pos={471.00, 193.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable setvar_WaveBuilder_P17, title="Delta"
	...
	SetVariable setvar_WaveBuilder_P15, pos={471.00, 170.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable setvar_WaveBuilder_P15, title="Delta"
	...
	SetVariable setvar_WaveBuilder_P13, pos={471.00, 147.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable setvar_WaveBuilder_P13, title="Delta"
	...
	SetVariable setvar_WaveBuilder_P11, pos={471.00, 124.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable setvar_WaveBuilder_P11, title="Delta"
	...
	SetVariable SetVar_WaveBuilder_P2, pos={365.00, 76.00}, size={100.00, 18.00}, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P2, title="Amplitude"
	...
	SetVariable SetVar_WaveBuilder_P3, pos={471.00, 75.00}, size={100.00, 18.00}, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P3, title="Delta"
	...
	SetVariable setvar_WaveBuilder_SetNumber, pos={25.00, 310.00}, size={83.00, 18.00}, bodyWidth=35
	SetVariable setvar_WaveBuilder_SetNumber, title="Number"
	...
	SetVariable SetVar_WaveBuilder_P4, pos={365.00, 101.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P4, title="Offset"
	...
	SetVariable SetVar_WaveBuilder_P6, pos={364.00, 122.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P6, title="Start Freq"
	...
	SetVariable setvar_WaveBuilder_CurrentEpoch, pos={32.00, 114.00}, size={122.00, 22.00}, proc=WBP_SetVarProc_EpochToEdit
	SetVariable setvar_WaveBuilder_CurrentEpoch, title="Epoch to edit"
	...
	SetVariable SetVar_WaveBuilder_P5, pos={470.00, 100.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P5, title="Delta"
	...
	SetVariable SetVar_WaveBuilder_P7, pos={470.00, 122.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P7, title="Delta", help={"Start frequency delta"}
	...
	SetVariable SetVar_WaveBuilder_P8, pos={366.00, 148.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P8, title="Pulse Dur"
	...
	SetVariable SetVar_WaveBuilder_P9, pos={471.00, 148.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P9, title="Delta"
	...
	Button button_WaveBuilder_KillSet, pos={22.00, 472.00}, size={125.00, 20.00}, proc=WBP_ButtonProc_DeleteSet
	Button button_WaveBuilder_KillSet, title="Delete Set"
	...
	Button button_WaveBuilder_SaveSet, pos={22.00, 351.00}, size={125.00, 20.00}, proc=WBP_ButtonProc_SaveSet
	Button button_WaveBuilder_SaveSet, title="Save Set"
	...
	SetVariable SetVar_WaveBuilder_P6_FD00, pos={364.00, 124.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P6_FD00, title="Freq", help={"Saw tooth frequency"}
	...
	SetVariable SetVar_WaveBuilder_P7_DD00, pos={470.00, 124.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P7_DD00, title="Delta"
	...
	SetVariable SetVar_WaveBuilder_P6_FD01, pos={366.00, 124.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P6_FD01, title="Freq", userdata(tabnum)="5"
	...
	SetVariable SetVar_WaveBuilder_P7_DD01, pos={471.00, 124.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P7_DD01, title="Delta", userdata(tabnum)="5"
	...
	SetVariable SetVar_WaveBuilder_P4_OD00, pos={365.00, 100.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P4_OD00, title="Offset", help={"Noise offset."}
	...
	SetVariable SetVar_WaveBuilder_P5_DD02, pos={471.00, 98.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P5_DD02, title="Delta"
	...
	SetVariable SetVar_WaveBuilder_P5_DD03, pos={470.00, 98.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P5_DD03, title="Delta", userdata(tabnum)="3"
	...
	SetVariable SetVar_WaveBuilder_P4_OD01, pos={364.00, 98.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P4_OD01, title="Offset", userdata(tabnum)="3"
	...
	SetVariable SetVar_WaveBuilder_P5_DD04, pos={470.00, 100.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P5_DD04, title="Delta", userdata(tabnum)="4"
	...
	SetVariable SetVar_WaveBuilder_P4_OD02, pos={364.00, 100.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P4_OD02, title="Offset", userdata(tabnum)="4"
	...
	SetVariable SetVar_WaveBuilder_P5_DD05, pos={471.00, 100.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P5_DD05, title="Delta", userdata(tabnum)="5"
	...
	SetVariable SetVar_WaveBuilder_P4_OD03, pos={366.00, 100.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P4_OD03, title="Offset", userdata(tabnum)="5"
	...
	SetVariable SetVar_WaveBuilder_P5_DD06, pos={471.00, 100.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P5_DD06, title="Delta"
	...
	SetVariable SetVar_WaveBuilder_P4_OD04, pos={365.00, 100.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P4_OD04, title="Offset"
	...
	SetVariable SetVar_WaveBuilder_P4_OD05, pos={363.00, 53.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P4_OD05, title="Offset", userdata(tabnum)="7"
	...
	SetVariable SetVar_WaveBuilder_P5_DD07, pos={469.00, 53.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P5_DD07, title="Delta", userdata(tabnum)="7"
	...
	SetVariable setvar_WaveBuilder_SearchString, pos={558.00, 172.00}, size={212.00, 33.00}, disable=1, proc=WBP_SetVarProc_SetSearchString
	SetVariable setvar_WaveBuilder_SearchString, title="Search\rstring"
	...
	PopupMenu popup_WaveBuilder_ListOfWaves, pos={556.00, 142.00}, size={215.00, 30.00}, bodyWidth=175, disable=1, proc=WBP_PopMenuProc_WaveToLoad
	PopupMenu popup_WaveBuilder_ListOfWaves, title="Wave\rto load"
	...
	SetVariable SetVar_WaveBuilder_P20, pos={364.00, 124.00}, size={101.00, 18.00}, bodyWidth=49, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P20, title="Low pass"
	...
	SetVariable SetVar_WaveBuilder_P21, pos={471.00, 122.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P21, title="Delta"
	...
	SetVariable SetVar_WaveBuilder_P22, pos={359.00, 148.00}, size={106.00, 18.00}, bodyWidth=50, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P22, title="High pass"
	...
	SetVariable SetVar_WaveBuilder_P23, pos={471.00, 148.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P23, title="Delta"
	...
	CheckBox check_SPT_Poisson_P44, pos={880.00, 123.00}, size={121.00, 15.00}, disable=1, proc=WBP_CheckProc
	CheckBox check_SPT_Poisson_P44, title="Poisson distribution"
	...
	SetVariable SetVar_WaveBuilder_P24, pos={364.00, 146.00}, size={100.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P24, title="End Freq", help={"Chirp end frequency"}
	...
	SetVariable SetVar_WaveBuilder_P25, pos={470.00, 146.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P25, title="Delta"
	...
	CheckBox check_Sin_Chirp_P43, pos={878.00, 168.00}, size={63.00, 15.00}, disable=1, proc=WBP_CheckProc
	CheckBox check_Sin_Chirp_P43, title="log chirp"
	...
	SetVariable SetVar_WB_DurDeltaMult_P52, pos={573.00, 52.00}, size={57.00, 18.00}, disable=2, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DurDeltaMult_P52, title="* "
	...
	PopupMenu popup_WaveBuilder_FolderList, pos={562.00, 111.00}, size={209.00, 30.00}, bodyWidth=175, disable=1, proc=WBP_PopMenuProc_FolderSelect
	PopupMenu popup_WaveBuilder_FolderList, title="Select\rfolder"
	...
	GroupBox group_WaveBuilder_FolderPath, pos={532.00, 88.00}, size={269.00, 127.00}, disable=1
	GroupBox group_WaveBuilder_FolderPath, title="root:MIES:WaveBuilder:"
	...
	PopupMenu popup_noise_type_P54, pos={884.00, 97.00}, size={129.00, 19.00}, bodyWidth=100, disable=1, proc=WBP_PopupMenu
	PopupMenu popup_noise_type_P54, title="Type"
	...
	CheckBox check_PreventUpdate, pos={34.00, 525.00}, size={96.00, 15.00}, proc=WBP_CheckProc_PreventUpdate
	CheckBox check_PreventUpdate, title="Prevent update"
	...
	SetVariable SetVar_WB_AmpDeltaMult_P50, pos={573.00, 75.00}, size={57.00, 18.00}, disable=2, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_AmpDeltaMult_P50, title="* "
	...
	SetVariable SetVar_WB_DeltaMult_P51, pos={575.00, 100.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P51, title="* "
	...
	SetVariable SetVar_WB_DeltaMult_P51_0, pos={575.00, 100.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P51_0, title="* ", userdata(tabnum)="2"
	...
	SetVariable SetVar_WB_DeltaMult_P51_1, pos={574.00, 99.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P51_1, title="* ", userdata(tabnum)="3"
	...
	SetVariable SetVar_WB_DeltaMult_P51_2, pos={575.00, 100.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P51_2, title="* ", userdata(tabnum)="4"
	...
	SetVariable SetVar_WB_DeltaMult_P51_3, pos={573.00, 100.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P51_3, title="* ", userdata(tabnum)="5"
	...
	SetVariable SetVar_WB_DeltaMult_P51_4, pos={571.00, 99.00}, size={57.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P51_4, title="* ", userdata(tabnum)="6"
	...
	SetVariable SetVar_WB_DeltaMult_P51_5, pos={575.00, 53.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P51_5, title="*", userdata(tabnum)="7"
	...
	SetVariable SetVar_WaveBuilder_P45, pos={366.00, 171.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P45, title="# Pulses"
	...
	SetVariable SetVar_WaveBuilder_P47, pos={471.00, 171.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P47, title="Delta"
	...
	CheckBox check_SPT_NumPulses_P46, pos={880.00, 145.00}, size={71.00, 15.00}, disable=1, proc=WBP_CheckProc
	CheckBox check_SPT_NumPulses_P46, title="Use Pulses"
	...
	Button button_NewSeed_P48, pos={884.00, 148.00}, size={72.00, 20.00}, disable=1, proc=WBP_ButtonProc_NewSeed
	Button button_NewSeed_P48, title="New Noise"
	...
	CheckBox check_NewSeedForEachSweep_P49, pos={884.00, 175.00}, size={86.00, 15.00}, disable=1, proc=WBP_CheckProc
	CheckBox check_NewSeedForEachSweep_P49, title="Seed / Sweep"
	...
	CheckBox check_FlipEpoch_S98, pos={118.00, 139.00}, size={35.00, 15.00}, proc=WBP_CheckProc
	CheckBox check_FlipEpoch_S98, title="Flip"
	...
	Button button_af_jump_to_proc, pos={18.00, 241.00}, size={135.00, 22.00}, proc=WBP_ButtonProc_OpenAnaFuncs
	Button button_af_jump_to_proc, title="Open procedure file"
	...
	PopupMenu popup_WaveBuilder_build_res_P55, pos={884.00, 121.00}, size={129.00, 19.00}, bodyWidth=40, disable=1, proc=WBP_PopupMenu
	PopupMenu popup_WaveBuilder_build_res_P55, title="Build Resolution"
	...
	SetVariable SetVar_WaveBuilder_P26, pos={352.00, 173.00}, size={113.00, 18.00}, bodyWidth=50, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P26, title="Filter Order"
	...
	SetVariable SetVar_WaveBuilder_P27, pos={471.00, 173.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P27, title="Delta", help={"Filter order delta."}
	...
	CheckBox check_NewSeedForEachSweep_P49_0, pos={880.00, 57.00}, size={86.00, 15.00}, disable=3, proc=WBP_CheckProc
	CheckBox check_NewSeedForEachSweep_P49_0, title="Seed / Sweep"
	...
	Button button_NewSeed_P48_0, pos={880.00, 98.00}, size={72.00, 20.00}, disable=3, proc=WBP_ButtonProc_NewSeed
	Button button_NewSeed_P48_0, title="New Seed"
	...
	SetVariable SetVar_WaveBuilder_P28, pos={365.00, 194.00}, size={100.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P28, title="First Freq", userdata(tabnum)="5"
	...
	SetVariable SetVar_WaveBuilder_P30, pos={365.00, 214.00}, size={100.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P30, title="Last Freq", userdata(tabnum)="5"
	...
	SetVariable SetVar_WaveBuilder_P29, pos={471.00, 193.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P29, title="Delta", userdata(tabnum)="5"
	...
	SetVariable SetVar_WaveBuilder_P31, pos={471.00, 214.00}, size={100.00, 18.00}, disable=1, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_P31, title="Delta", userdata(tabnum)="5"
	...
	CheckBox check_SPT_MixedFreqShuffle_P42, pos={880.00, 211.00}, size={89.00, 15.00}, disable=1, proc=WBP_CheckProc
	CheckBox check_SPT_MixedFreqShuffle_P42, title="Shuffle pulses"
	...
	CheckBox check_UseStimsetSeed_P39, pos={884.00, 195.00}, size={121.00, 15.00}, disable=1, proc=WBP_CheckProc
	CheckBox check_UseStimsetSeed_P39, title="Epoch/Stimset Seed"
	...
	CheckBox check_UseEpochSeed_P39_0, pos={880.00, 79.00}, size={121.00, 15.00}, disable=3, proc=WBP_CheckProc
	CheckBox check_UseEpochSeed_P39_0, title="Epoch/Stimset Seed"
	...
	CheckBox check_allow_saving_builtin_nam, pos={28.00, 290.00}, size={116.00, 15.00}
	CheckBox check_allow_saving_builtin_nam, title="Allow reserv. name"
	...
	PopupMenu popup_af_generic_S9, pos={16.00, 191.00}, size={143.00, 19.00}, bodyWidth=100, proc=WBP_PopupMenu_AnalysisFunctions
	PopupMenu popup_af_generic_S9, title="Generic"
	...
	Button button_toggle_params, pos={18.00, 214.00}, size={137.00, 23.00}, proc=WBP_ButtonProc_OpenAnaParamGUI
	Button button_toggle_params, title="Open parameters panel"
	...
	SetVariable SetVar_WB_DurDeltaMult_P63, pos={575.00, 124.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DurDeltaMult_P63, title="* "
	...
	SetVariable SetVar_WB_AmpDeltaMult_P64, pos={575.00, 148.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_AmpDeltaMult_P64, title="* "
	...
	SetVariable SetVar_WB_DeltaMult_P66, pos={575.00, 172.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P66, title="* ", userdata(tabnum)="2"
	...
	PopupMenu popup_WaveBuilder_op_P82, help={"Delta operation"}, userdata(tabnum)="2"
	...
	PopupMenu popup_WaveBuilder_op_P80, help={"Delta operation"}, userdata(tabnum)="2"
	...
	PopupMenu popup_WaveBuilder_op_P79, help={"Delta operation"}, userdata(tabnum)="2"
	...
	SetVariable SetVar_WB_DeltaMult_P57, pos={574.00, 122.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P57, title="* ", userdata(tabnum)="3"
	...
	SetVariable SetVar_WB_DeltaMult_P65, pos={574.00, 146.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P65, title="* ", userdata(tabnum)="3"
	...
	PopupMenu popup_WaveBuilder_op_P81, help={"Delta operation"}, userdata(tabnum)="3"
	...
	SetVariable SetVar_WB_DeltaMult_P57_DD01, pos={573.00, 123.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P57_DD01, title="* ", userdata(tabnum)="5"
	...
	SetVariable SetVar_WB_DeltaMult_P58, pos={573.00, 146.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P58, title="* ", userdata(tabnum)="5"
	...
	SetVariable SetVar_WB_DeltaMult_P69, pos={573.00, 169.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P69, title="* ", userdata(tabnum)="5"
	...
	SetVariable SetVar_WB_DeltaMult_P67, pos={573.00, 192.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P67, title="* ", userdata(tabnum)="5"
	...
	PopupMenu popup_WaveBuilder_op_P83, pos={635.00, 191.00}, size={75.00, 19.00}, bodyWidth=75, disable=3, proc=WBP_PopupMenu
	...
	SetVariable SetVar_WB_DeltaMult_P68, pos={573.00, 215.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P68, title="* ", userdata(tabnum)="5"
	...
	PopupMenu popup_WaveBuilder_op_P84, pos={635.00, 215.00}, size={75.00, 19.00}, bodyWidth=75, disable=3, proc=WBP_PopupMenu
	...
	SetVariable SetVar_WB_DeltaMult_P57_03, pos={574.00, 123.00}, size={55.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P57_03, title="* ", userdata(tabnum)="4"
	...
	SetVariable SetVar_WB_DeltaMult_P60, pos={571.00, 145.00}, size={57.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P60, title="* ", userdata(tabnum)="6"
	...
	PopupMenu popup_WaveBuilder_op_P76, help={"Delta operation"}, userdata(tabnum)="6"
	...
	SetVariable SetVar_WB_DeltaMult_P61, pos={571.00, 168.00}, size={57.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P61, title="* ", userdata(tabnum)="6"
	...
	PopupMenu popup_WaveBuilder_op_P77, help={"Delta operation"}, userdata(tabnum)="6"
	...
	SetVariable SetVar_WB_DeltaMult_P62, pos={571.00, 192.00}, size={57.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P62, title="* ", userdata(tabnum)="6"
	...
	PopupMenu popup_WaveBuilder_op_P78, help={"Delta operation"}, userdata(tabnum)="6"
	...
	SetVariable SetVar_WB_DeltaMult_P59, pos={571.00, 122.00}, size={57.00, 18.00}, disable=3, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_DeltaMult_P59, title="* ", userdata(tabnum)="6"
	...
	SetVariable SetVar_WaveBuilder_S96, pos={258.00, 49.00}, size={75.00, 18.00}, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_S96, title="Delta"
	...
	SetVariable SetVar_WB_Multiplier_S95, pos={198.00, 71.00}, size={57.00, 18.00}, disable=2, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WB_Multiplier_S95, title="* "
	...
	SetVariable SetVar_WaveBuilder_S99, pos={195.00, 49.00}, size={60.00, 18.00}, proc=WBP_SetVarProc_UpdateParam
	SetVariable SetVar_WaveBuilder_S99, title="ITI"
	...
	GroupBox group_anafunc_params, pos={12.00, 170.00}, size={160.00, 99.00}
	GroupBox group_anafunc_params, title="Analysis functions"
	...
	Button button_WaveBuilder_SaveSet1, pos={22.00, 398.00}, size={125.00, 20.00}, proc=WBP_ButtonProc_LoadSet
	Button button_WaveBuilder_SaveSet1, title="Load Set"
	...
	SetVariable setvar_WaveBuilder_search, pos={23.00, 443.00}, size={125.00, 18.00}
	SetVariable setvar_WaveBuilder_search, title="Search filter"
	...
	SetWindow kwTopWin, userdata(JSONSettings_WindowGroup)="wavebuilder"
