...
Function/Wave DC_ControlStatusWave(panelTitle, type)
	...
	for(i = 0; i < numEntries; i += 1)
		ctrl = DAP_GetPanelControl(i, type, CHANNEL_CONTROL_CHECK)
...
static Function DC_PlaceDataInITCChanConfigWave(panelTitle, dataAcqOrTP)
	...
	for(i = 0; i < numEntries; i += 1)
		...
		ctrl = DAP_GetPanelControl(i, CHANNEL_TYPE_DAC, CHANNEL_CONTROL_UNIT)
	...
	for(i = 0; i < numEntries; i += 1)
		...
		ITCChanConfigWave[j][1] = i
		ctrl = DAP_GetPanelControl(i, CHANNEL_TYPE_ADC, CHANNEL_CONTROL_UNIT)
		unitList = AddListItem(GetSetVariableString(panelTitle, ctrl), unitList, ";", Inf)
		j += 1
	endfor
...
static Function DC_PlaceDataInITCDataWave(panelTitle, dataAcqOrTP, multiDevice)
	...
	for(i = 0; i < numEntries; i += 1)
		...
		ctrl = DAP_GetPanelControl(i, CHANNEL_TYPE_DAC, CHANNEL_CONTROL_SCALE)
		...
		ctrl = DAP_GetPanelControl(i, CHANNEL_TYPE_DAC, CHANNEL_CONTROL_GAIN)
	...
	for(i = 0; i < numEntries; i += 1)
		...
		ctrl = DAP_GetPanelControl(i, CHANNEL_TYPE_ADC, CHANNEL_CONTROL_GAIN)
