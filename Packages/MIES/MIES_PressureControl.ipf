...
static Function P_PrepareITCWaves(mainDevice, pressureDevice)
	...
	if(!cmpstr(deviceType, "ITC1600")) // two racks
		...
		Redimension/N=(4, -1) ITCConfig, FIFOConfig

		SetDimLabel COLS, 3, TTL_R1, ITCData
		SetDimLabel ROWS, 3, TTL_R1, ITCConfig, FIFOConfig
		...
		Redimension/N=(3, -1) ITCConfig, FIFOConfig
	endif
...
Function P_ITC_FIFOMonitorProc(s)
	...
	HW_SelectDevice(hwType, deviceID, flags=HARDWARE_ABORT_ON_ERROR)
	moreData = HW_ITC_MoreData(deviceID, configFunc=P_GetITCFIFOConfig, ADChannelToMonitor=1, stopCollectionPoint=350 / HARDWARE_ITC_MIN_SAMPINT)
