...
static Function CONF_MCC_MidExp(string device, variable headStage, variable jsonID)
	...
	if(clampMode == V_CLAMP_MODE)
		...
		settingValue = AI_ReadFromAmplifier(device, headStage, V_CLAMP_MODE, MCC_PIPETTEOFFSET_FUNC, checkBeforeWrite = 1)
		...
		settingValue = AI_ReadFromAmplifier(device, headStage, V_CLAMP_MODE, MCC_HOLDING_FUNC, checkBeforeWrite = 1)
		PGC_SetAndActivateControl(device, "setvar_DataAcq_Hold_VC", val = settingValue)
		settingValue = AI_ReadFromAmplifier(device, headStage, V_CLAMP_MODE, MCC_HOLDINGENABLE_FUNC, checkBeforeWrite = 1)
	...
	elseif(clampMode == I_CLAMP_MODE)
		settingValue = AI_ReadFromAmplifier(device, headStage, I_CLAMP_MODE, MCC_PIPETTEOFFSET_FUNC, checkBeforeWrite = 1)
		PGC_SetAndActivateControl(device, "setvar_DataAcq_PipetteOffset_VC", val = settingValue)
		PGC_SetAndActivateControl(device, "setvar_DataAcq_PipetteOffset_IC", val = settingValue)
		settingValue = AI_ReadFromAmplifier(device, headStage, I_CLAMP_MODE, MCC_HOLDING_FUNC, checkBeforeWrite = 1)
		PGC_SetAndActivateControl(device, "setvar_DataAcq_Hold_IC", val = settingValue)
		settingValue = AI_ReadFromAmplifier(device, headStage, I_CLAMP_MODE, MCC_HOLDINGENABLE_FUNC, checkBeforeWrite = 1)
		PGC_SetAndActivateControl(device, "check_DatAcq_HoldEnable", val = settingValue)
		settingValue = AI_ReadFromAmplifier(device, headStage, I_CLAMP_MODE, MCC_BRIDGEBALRESIST_FUNC, checkBeforeWrite = 1)
		PGC_SetAndActivateControl(device, "setvar_DataAcq_BB", val = settingValue)
		settingValue = AI_ReadFromAmplifier(device, headStage, I_CLAMP_MODE, MCC_BRIDGEBALENABLE_FUNC, checkBeforeWrite = 1)
		PGC_SetAndActivateControl(device, "check_DatAcq_BBEnable", val = settingValue)
		settingValue = AI_ReadFromAmplifier(device, headStage, I_CLAMP_MODE, MCC_NEUTRALIZATIONCAP_FUNC, checkBeforeWrite = 1)
		PGC_SetAndActivateControl(device, "setvar_DataAcq_CN", val = settingValue)
		settingValue = AI_ReadFromAmplifier(device, headStage, I_CLAMP_MODE, MCC_NEUTRALIZATIONENABL_FUNC, checkBeforeWrite = 1)
