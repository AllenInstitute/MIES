...
///
/// @return 1 if already running, otherwise 0
Function StartZeroMQSockets([variable forceRestart])
	...
	if(numBinds == expectedBinds)
		...
		printf "Could only establish %d ZeroMQ bind connections and not %d. Shutting down ZeroMQ subsystem.", numBinds, expectedBinds
