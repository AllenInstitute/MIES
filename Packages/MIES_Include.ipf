...
// .. |IgorPro10WindowsNightly| replace:: `Igor Pro 10 (Windows) <https://www.byte-physics.de/Downloads/setupIgor10_r30040.exe>`__
...
#define TOO_OLD_IGOR
#elif IgorVersion() == 10 && (NumberByKey("BUILD", IgorInfo(0)) < 30040)
#define TOO_OLD_IGOR
#endif
...
#include "MIES_SweepFormula_Operations_Select"
#include "MIES_SweepFormula_Operations_TP"
