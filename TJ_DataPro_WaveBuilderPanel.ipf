...
Window wavebuilder() : Panel
	...
	SetVariable setvar_WaveBuilder_SegmentEdit,fSize=14,limits={0,0,1},value= _NUM:0
	...
	SetVariable SetVar_WaveBuilder_P8,limits={0,0.99901,0.1},value= _NUM:0
