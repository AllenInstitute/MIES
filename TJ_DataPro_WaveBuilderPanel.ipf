...
Window WaveBuilder() : Panel
	...
	NewPanel /W=(179,118,1157,581)
	SetVariable SetVar_WaveBuilder_NoOfSegments,pos={142,35},size={150,16},proc=SetVarProc_1,title="Total Epochs"
	SetVariable SetVar_WaveBuilder_NoOfSegments,userdata(tabcontrol)=  "WBP_WaveType"
	SetVariable SetVar_WaveBuilder_NoOfSegments,userdata(ResizeControlsInfo)= A"!!,Ff!!#:\"!!#A%!!#<8z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	SetVariable SetVar_WaveBuilder_NoOfSegments,limits={1,101,1},value= _NUM:2
	SetVariable SetVar_WaveBuilder_P0,pos={311,34},size={150,16},disable=2,proc=SetVarProc_2,title="Duration"
	...
	SetVariable SetVar_WaveBuilder_P1,pos={466,34},size={150,16},disable=2,proc=SetVarProc_2,title="Delta"
	...
	SetVariable SetVar_WaveBuilder_StepCount,userdata(ResizeControlsInfo)= A"!!,Fg!!#=[!!#A%!!#<8z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	SetVariable SetVar_WaveBuilder_StepCount,limits={1,99,1},value= _NUM:1
	SetVariable setvar_WaveBuilder_P10,pos={692,34},size={100,16},disable=1,proc=SetVarProc_2,title="Tau Rise"
	SetVariable setvar_WaveBuilder_P10,userdata(tabnum)=  "6"
	SetVariable setvar_WaveBuilder_P10,userdata(tabcontrol)=  "WBP_WaveType"
	SetVariable setvar_WaveBuilder_P10,userdata(ResizeControlsInfo)= A"!!,J8!!#=k!!#@,!!#<8z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	SetVariable setvar_WaveBuilder_P12,pos={692,56},size={100,16},disable=1,proc=SetVarProc_2,title="Tau Decay 1"
	SetVariable setvar_WaveBuilder_P12,userdata(tabnum)=  "6"
	SetVariable setvar_WaveBuilder_P12,userdata(tabcontrol)=  "WBP_WaveType"
	SetVariable setvar_WaveBuilder_P12,userdata(ResizeControlsInfo)= A"!!,J8!!#>n!!#@,!!#<8z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	SetVariable setvar_WaveBuilder_P14,pos={692,80},size={100,16},disable=1,proc=SetVarProc_2,title="Tau Decay 2"
	SetVariable setvar_WaveBuilder_P14,userdata(tabnum)=  "6"
	SetVariable setvar_WaveBuilder_P14,userdata(tabcontrol)=  "WBP_WaveType"
	SetVariable setvar_WaveBuilder_P14,userdata(ResizeControlsInfo)= A"!!,J8!!#?Y!!#@,!!#<8z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	SetVariable setvar_WaveBuilder_P16,pos={692,103},size={100,16},disable=1,proc=SetVarProc_2,title="Tau 2 weight"
	SetVariable setvar_WaveBuilder_P16,userdata(tabnum)=  "6"
	SetVariable setvar_WaveBuilder_P16,userdata(tabcontrol)=  "WBP_WaveType"
	SetVariable setvar_WaveBuilder_P16,userdata(ResizeControlsInfo)= A"!!,J8!!#@2!!#@,!!#<8z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	SetVariable SetVar_WaveBuilder_P2,pos={311,57},size={150,16},disable=2,proc=SetVarProc_2,title="Amplitude"
	...
	SetVariable SetVar_WaveBuilder_P3,pos={466,57},size={150,16},disable=2,proc=SetVarProc_2,title="Delta"
	...
	SetVariable setvar_WaveBuilder_SetNumber,userdata(ResizeControlsInfo)= A"!!,G>!!#?e!!#@,!!#<8z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	SetVariable SetVar_WaveBuilder_P4,pos={311,81},size={150,16},disable=1,proc=SetVarProc_2,title="Offset"
	...
	SetVariable SetVar_WaveBuilder_P6,pos={311,105},size={150,16},disable=1,proc=SetVarProc_2,title="Frequency"
	...
	SetVariable setvar_WaveBuilder_SegmentEdit,pos={167,82},size={125,16},proc=SetVarProc,title="Epoch to edit"
	SetVariable setvar_WaveBuilder_SegmentEdit,userdata(tabcontrol)=  "WBP_WaveType"
	SetVariable setvar_WaveBuilder_SegmentEdit,userdata(ResizeControlsInfo)= A"!!,G(!!#>r!!#@^!!#<8z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	SetVariable setvar_WaveBuilder_SegmentEdit,limits={0,1,1},value= _NUM:0
	SetVariable SetVar_WaveBuilder_P5,pos={466,81},size={150,16},disable=1,proc=SetVarProc_2,title="Delta"
	...
	SetVariable SetVar_WaveBuilder_P7,pos={466,105},size={150,16},disable=1,proc=SetVarProc_2,title="Delta"
	...
	SetVariable SetVar_WaveBuilder_P8,pos={311,129},size={150,16},disable=1,proc=SetVarProc_2,title="Pulse Duration"
	...
	SetVariable SetVar_WaveBuilder_P9,pos={466,129},size={150,16},disable=1,proc=SetVarProc_2,title="Delta"
	...
	SetVariable setvar_WaveBuilder_baseName,userdata(ResizeControlsInfo)= A"!!,F]!!#@D!!#A%!!#<8z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	PopupMenu popup_WaveBuilder_SetList,pos={63,426},size={150,21},bodyWidth=150
	PopupMenu popup_WaveBuilder_SetList,userdata(tabcontrol)=  "WBP_WaveType"
	PopupMenu popup_WaveBuilder_SetList,userdata(ResizeControlsInfo)= A"!!,E&!!#C&!!#A%!!#<`z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	Button button_WaveBuilder_KillSet,pos={219,424},size={148,23},proc=ButtonProc,title="Delete Set"
	...
	CheckBox check_WaveBuilder_exp,pos={623,32},size={49,20},proc=CheckProc,title="Delta\\S2"
	CheckBox check_WaveBuilder_exp,userdata(tabcontrol)=  "WBP_WaveType"
	CheckBox check_WaveBuilder_exp,userdata(ResizeControlsInfo)= A"!!,J,^]6\\0!!#>R!!#<Xz!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	CheckBox check_WaveBuilder_exp,value= 1
	Button button_WaveBuilder_setaxisA,pos={806,430},size={75,20},proc=ButtonProc_1,title="Autoscale"
	Button button_WaveBuilder_setaxisA,userdata(tabcontrol)=  "WBP_WaveType"
	Button button_WaveBuilder_setaxisA,userdata(ResizeControlsInfo)= A"!!,JZJ,hsOJ,hp%!!#<Xz!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	PopupMenu popup_WaveBuilder_OutputType,pos={7,4},size={124,21},bodyWidth=65,proc=PopMenuProc,title="Wave Type"
	...
	PopupMenu popup_WaveBuilder_OutputType,userdata(ResizeControlsInfo)= A"!!,C<!!#;-!!#?[!!#=3z!!#](Aon\"Qzzzzzzzzzzzzzz!!#](Aon\"Qzz"
	...
	SetVariable SetVar_WaveBuilder_FD00,pos={311,105},size={150,16},disable=1,proc=SetVarProc_5,title="Frequency"
	...
	SetVariable SetVar_WaveBuilder_FD00,value= _NUM:200
	SetVariable SetVar_WaveBuilder_DD00,pos={466,105},size={150,16},disable=1,proc=SetVarProc_6,title="Delta"
	...
	SetVariable SetVar_WaveBuilder_FD01,pos={311,105},size={150,16},disable=1,proc=SetVarProc_5,title="Frequency"
	...
	SetVariable SetVar_WaveBuilder_DD01,pos={466,105},size={150,16},disable=1,proc=SetVarProc_6,title="Delta"
	...
	SetVariable SetVar_WaveBuilder_DD01,value= _NUM:1
	SetVariable SetVar_WaveBuilder_OD00,pos={311,81},size={150,16},disable=1,proc=SetVarProc_7,title="Offset"
	...
	SetVariable SetVar_WaveBuilder_DD02,pos={466,81},size={150,16},disable=1,proc=SetVarProc_8,title="Delta"
	...
	SetVariable SetVar_WaveBuilder_DD03,pos={466,81},size={150,16},disable=1,proc=SetVarProc_8,title="Delta"
	...
	SetVariable SetVar_WaveBuilder_OD01,pos={311,81},size={150,16},disable=1,proc=SetVarProc_7,title="Offset"
	...
	SetVariable SetVar_WaveBuilder_DD04,pos={466,81},size={150,16},disable=1,proc=SetVarProc_8,title="Delta"
	...
	SetVariable SetVar_WaveBuilder_OD02,pos={311,81},size={150,16},disable=1,proc=SetVarProc_7,title="Offset"
	...
	SetVariable SetVar_WaveBuilder_DD05,pos={466,81},size={150,16},disable=1,proc=SetVarProc_8,title="Delta"
	...
	SetVariable SetVar_WaveBuilder_OD03,pos={311,81},size={150,16},disable=1,proc=SetVarProc_7,title="Offset"
	...
	SetVariable SetVar_WaveBuilder_DD06,pos={466,81},size={150,16},disable=1,proc=SetVarProc_8,title="Delta"
	...
	SetVariable SetVar_WaveBuilder_OD04,pos={312,81},size={150,16},disable=1,proc=SetVarProc_7,title="Offset"
	...
	SetVariable SetVar_WaveBuilder_P18,pos={311,81},size={150,16},proc=SetVarProc_2,title="Offset"
	...
	SetVariable SetVar_WaveBuilder_P19,pos={466,81},size={150,16},proc=SetVarProc_2,title="Delta"
	...
	SetVariable setvar_WaveBuilder_SearchString,pos={688,35},size={216,30},proc=SetVarProc_SetSearchString,title="Search\rstring"
	...
	PopupMenu popup_WaveBuilder_ListOfWaves,pos={691,70},size={212,26},bodyWidth=177,proc=PopMenuProc_1,title="Wave\rto load"
	...
	SetVariable SetVar_WaveBuilder_P20,pos={685,32},size={150,30},disable=1,proc=SetVarProc_2,title="Low pass cut \roff frequency"
	...
	SetVariable SetVar_WaveBuilder_P21,pos={840,32},size={91,16},disable=1,proc=SetVarProc_2,title="Delta"
	...
	SetVariable SetVar_WaveBuilder_P22,pos={685,71},size={150,30},disable=1,proc=SetVarProc_2,title="High pass cut \roff frequency"
	...
	SetVariable SetVar_WaveBuilder_P23,pos={841,71},size={91,16},disable=1,proc=SetVarProc_2,title="Delta"
	...
	SetWindow kwTopWin,userdata(ResizeControlsInfo)= A"!!*'\"z!!#DuJ,hsizzzzzzzzzzzzzzzzzzzzz"
	SetWindow kwTopWin,userdata(ResizeControlsInfo) += A"zzzzzzzzzzzzzzzzzzzzzzzzz"
	SetWindow kwTopWin,userdata(ResizeControlsInfo) += A"zzzzzzzzzzzzzzzzzzz!!!"
	Display/W=(36,126,957,413)/HOST=#  '1_ladida_DAC_Set_1'
	ModifyGraph rgb=(13056,13056,13056)
	SetWindow kwTopWin,userdata(tabcontrol)=  "WBP_WaveType"
	SetWindow kwTopWin,userdata(ResizeControlsInfo)= A"!!,Ct!!#A/!!#Df5QF/K!!!!\"zzzzzzzzzzzzzzzzzzzz"
	SetWindow kwTopWin,userdata(ResizeControlsInfo) += A"zzzzzzzzzzzzzzzzzzzzzzzzz"
	SetWindow kwTopWin,userdata(ResizeControlsInfo) += A"zzzzzzzzzzzzzzzzzzz!!!"
...
Function SetVarProc_5(ctrlName,varNum,varStr,varName) : SetVariableControl// setvarproc 5-8 pass data from one setvariable control to another, they also run a version of the other controls procedures
	String ctrlName
	Variable varNum
	String varStr
	String varName
...
Function SetVarProc_6(ctrlName,varNum,varStr,varName) : SetVariableControl
	String ctrlName
	Variable varNum
	String varStr
	String varName
...
Function SetVarProc_2(ctrlName,varNum,varStr,varName) : SetVariableControl
	String ctrlName
	Variable varNum
	String varStr
	String varName
...
Function SetVarProc_7(ctrlName,varNum,varStr,varName) : SetVariableControl
	String ctrlName
	Variable varNum
	String varStr
	String varName
...
Function SetVarProc_8(ctrlName,varNum,varStr,varName) : SetVariableControl
	String ctrlName
	Variable varNum
	String varStr
	String varName
...
SetVarProc_2("SetVar_WaveBuilder_P2",0,"1","")
SetVariable SetVar_WaveBuilder_P3 disable=2,value= _NUM:0
SetVarProc_2("SetVar_WaveBuilder_P3",0,"0","")
SetVariable SetVar_WaveBuilder_P4 disable=2,value= _NUM:0
SetVarProc_2("SetVar_WaveBuilder_P4",0,"0","")
SetVariable SetVar_WaveBuilder_P5 disable=2,value= _NUM:0
SetVarProc_2("SetVar_WaveBuilder_P5",0,"0","")
...
Function SetVarProc_SetSearchString(ctrlName,varNum,varStr,varName) : SetVariableControl
	String ctrlName
	Variable varNum
	String varStr
	String varName
