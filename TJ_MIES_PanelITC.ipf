...
Window DA_Ephys() : Panel
	...
	Button StartTestPulseButton,pos={49,309},size={384,40},disable=1,proc=TP_ButtonProc_DataAcq_TestPulse,title="\\Z14\\f01Start Test \rPulse"
	...
	PopupMenu Popup_Settings_VC_AD,pos={32,448},size={59,21},proc=DAP_PopMenuProc_CAA,title="AD"
	...
	SetVariable setvar_Settings_VC_ADgain,value= _NUM:0.01
	...
	PopupMenu Popup_DA_IndexEnd_00,userdata(MenExp)= A"+tXpTDf0,//NZpCF*(6$Cia/L+tFj*AScHs<&8T;?UR1e0KX>iDJ*cs:j$SqAR@hk?SFQ?Bl79G6!l<-+o"
	PopupMenu Popup_DA_IndexEnd_00,userdata(MenuExp)= A"6tL1V@8o%(FC.F%?SFQ_Bl7R\"APdMcF(J]H6!l<-;e^,V6pY063r"
	PopupMenu Popup_DA_IndexEnd_00,mode=5,popvalue="Sin_DA_0",value= #"\"- none -;TestPulse;\"+\"DeltaT3st_DA_0;singlePulse_DA_0;Sin_DA_0;\""
	...
	ValDisplay valdisp_DataAcq_SweepsInSet,value= _NUM:nan
	...
	ValDisplay valdisp_DataAcq_SweepsActiveSet,value= _NUM:nan
	...
	SetVariable setvar_DataAcq_WCR,value= _NUM:25
