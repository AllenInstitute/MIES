...
Function RemoveTracesOnGraph()
	variable i=0
	string cmd, WaveNameFromList
	string ListOfTracesOnGraph
	string Tracename
	
	ListOfTracesOnGraph=TraceNameList("DataPro_ITC1600#Oscilloscope", ";",0+1)
	
	do
	TraceName = "\"#0\""
	sprintf cmd, "removefromgraph/w=DataPro_ITC1600#Oscilloscope $%s" TraceName
	execute cmd
	i+=1
