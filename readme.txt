...
* Doxygen 1.8.7 and GNU AWK for generating the documentation.
* VTD2.xop shipped with Igor PRO.

Installation:

* Quit Igor Pro
* Create the following shortcuts in "C:\Users\<username>\Documents\WaveMetrics\Igor Pro 6 User Files" 
  * In "User Procedures" a shortcut pointing to Packages\MIES, one to Packages\Arduino, one to Packages\HDF
